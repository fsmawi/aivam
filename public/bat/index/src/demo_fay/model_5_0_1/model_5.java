...
/**
 * Job: model_5 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class model_5 implements TalendJob {
	...
	private final String jobName = "model_5";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(model_5.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_model_5 = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_model_5 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_model_5.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_model_5.length == 0) {
						commonByteArray_DEMO_FAY_model_5 = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_model_5 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_model_5, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_model_5, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_5) {
	...
	public static void main(String[] args) {
		final model_5 model_5Class = new model_5();

		int exitCode = model_5Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_5.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/model_5_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : model_5");
		}
