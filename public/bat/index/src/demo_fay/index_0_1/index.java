...
/**
 * Job: index Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class index implements TalendJob {
	...
	private final String jobName = "index";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(index.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_1
						.put("file_brute", context.file_brute);

				parentContextMap_tRunJob_1.put("log_id", context.log_id);

				Object obj_tRunJob_1 = null;

				demo_fay.main_process_0_1.main_process childJob_tRunJob_1 = new demo_fay.main_process_0_1.main_process();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_2.put("log_id", context.log_id);

				Object obj_tRunJob_2 = null;

				demo_fay.models_0_1.models childJob_tRunJob_2 = new demo_fay.models_0_1.models();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_3.put("log_id", context.log_id);

				Object obj_tRunJob_3 = null;

				demo_fay.premium_segment_0_1.premium_segment childJob_tRunJob_3 = new demo_fay.premium_segment_0_1.premium_segment();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_4.put("log_id", context.log_id);

				Object obj_tRunJob_4 = null;

				demo_fay.origine_0_1.origine childJob_tRunJob_4 = new demo_fay.origine_0_1.origine();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_5.put("log_id", context.log_id);

				Object obj_tRunJob_5 = null;

				demo_fay.group_0_1.group childJob_tRunJob_5 = new demo_fay.group_0_1.group();
				// pass DataSources
	...
	public static void main(String[] args) {
		final index indexClass = new index();

		int exitCode = indexClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = index.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/index_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : index");
		}
...
/************************************************************************************************
 * 52205 characters generated by Talend Open Studio for Data Integration on the
