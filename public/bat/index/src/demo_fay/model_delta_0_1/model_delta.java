...
package demo_fay.model_delta_0_1;
...
/**
 * Job: model_delta Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class model_delta implements TalendJob {
	...
	private final String jobName = "model_delta";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(model_delta.this, new Object[] { e,
	...
	public static class copyOfout1Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_model_delta = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_model_delta = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_model_delta.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_model_delta.length == 0) {
						commonByteArray_DEMO_FAY_model_delta = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_model_delta = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_model_delta, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_model_delta, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_delta) {
				...
				try {
					...
					while (rs_tMysqlInput_2.next()) {
						...
						if (copyOfout1 != null) {
							...
							pstmt_tMysqlOutput_2.setInt(2, copyOfout1.year);

							pstmt_tMysqlOutput_2.setInt(3, copyOfout1.month);
							...
							pstmt_tMysqlOutput_2.setInt(16, copyOfout1.sales);
							...
							pstmt_tMysqlOutput_2.setInt(19, copyOfout1.rsp);
							...
							pstmt_tMysqlOutput_2.setInt(22, copyOfout1.log_id);
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int deleteKeyCount_tMysqlOutput_3 = 1;
				if (deleteKeyCount_tMysqlOutput_3 < 1) {
				...
				String delete_tMysqlOutput_3 = "DELETE  FROM `" + "items_temp"
						+ "` WHERE `id` = ?";

				java.sql.PreparedStatement pstmt_tMysqlOutput_3 = conn_tMysqlOutput_3
						.prepareStatement(delete_tMysqlOutput_3);
				...
				try {
					...
					while (rs_tMysqlInput_3.next()) {
						...
						{ // start of Var scope
							...
							out2_tmp.month = row3.month;
							out2_tmp.city = row3.city;
							out2_tmp.group = row3.group;
							out2_tmp.make = row3.make;
							out2_tmp.premium_segment = row3.premium_segment;
							out2_tmp.model_gnr = row3.model_gnr;
							out2_tmp.model = row3.model;
							out2_tmp.segment = row3.segment;
							out2_tmp.ckd_cbu = row3.ckd_cbu;
							out2_tmp.pc_cv = row3.pc_cv;
							out2_tmp.engine_type = row3.engine_type;
							out2_tmp.type = row3.type;
							out2_tmp.displacement = row3.displacement;
							out2_tmp.sales = row3.sales;
							out2_tmp.origine = row3.origine;
							out2_tmp.body_type = row3.body_type;
							out2_tmp.rsp = row3.rsp;
							out2_tmp.suv_type = row3.suv_type;
							out2_tmp.price_class = row3.price_class;
							out2_tmp.log_id = row3.log_id;
							out2_tmp.type_vh = row3.type_vh;
							out2_tmp.status = row3.status;
							out2_tmp.created_at = row3.created_at;
							out2_tmp.updated_at = row3.updated_at;
							out2_tmp.nb_portes = null;
							out2_tmp.nb_places = null;
							out2 = out2_tmp;
							// ###############################
						...
						if (out2 != null) {
							...
							pstmt_tMysqlOutput_3.setLong(1, out2.id);
							...
							if (batchSize_tMysqlOutput_3 <= batchSizeCounter_tMysqlOutput_3) {
								try {
									...
									deletedCount_tMysqlOutput_3 += countSum_tMysqlOutput_3;
	...
	public static void main(String[] args) {
		final model_delta model_deltaClass = new model_delta();

		int exitCode = model_deltaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_delta.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/model_delta_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : model_delta");
		}
...
/************************************************************************************************
 * 127989 characters generated by Talend Open Studio for Data Integration on the
 * November 28, 2015 11:41:08 PM GMT
 ************************************************************************************************/
