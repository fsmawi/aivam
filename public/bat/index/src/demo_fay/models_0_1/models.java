...
/**
 * Job: models Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class models implements TalendJob {
	...
	private final String jobName = "models";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(models.this, new Object[] { e,
	...
	public void tRunJob_15_error(java.lang.Exception exception,
	...
	public void tRunJob_16_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_11_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_13_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_14_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_17_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_15_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_16_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_11_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_13_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_14_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_17_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tRunJob_15Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_0_0_1.model_0 childJob_tRunJob_15 = new demo_fay.model_0_0_1.model_0();
				// pass DataSources
				...
				if (null != talendDataSources_tRunJob_15) {
					...
					for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_tRunJob_15 : talendDataSources_tRunJob_15
						...
						dataSources_tRunJob_15.put(
								talendDataSourceEntry_tRunJob_15.getKey(),
								talendDataSourceEntry_tRunJob_15.getValue()
										.getRawDataSource());
					}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_15:OnSubjobOk",
	...
	public void tRunJob_16Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_0_gnr_0_1.model_0_gnr childJob_tRunJob_16 = new demo_fay.model_0_gnr_0_1.model_0_gnr();
				// pass DataSources
				...
				if (null != talendDataSources_tRunJob_16) {
					...
					for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_tRunJob_16 : talendDataSources_tRunJob_16
						...
						dataSources_tRunJob_16.put(
								talendDataSourceEntry_tRunJob_16.getKey(),
								talendDataSourceEntry_tRunJob_16.getValue()
										.getRawDataSource());
					}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_16:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_1_0_1.model_1 childJob_tRunJob_2 = new demo_fay.model_1_0_1.model_1();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_2_0_1.model_2 childJob_tRunJob_3 = new demo_fay.model_2_0_1.model_2();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_3_0_1.model_3 childJob_tRunJob_4 = new demo_fay.model_3_0_1.model_3();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_4_0_1.model_4 childJob_tRunJob_5 = new demo_fay.model_4_0_1.model_4();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_5_0_1.model_5 childJob_tRunJob_6 = new demo_fay.model_5_0_1.model_5();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_6_0_1.model_6 childJob_tRunJob_7 = new demo_fay.model_6_0_1.model_6();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_7_0_1.model_7 childJob_tRunJob_8 = new demo_fay.model_7_0_1.model_7();
				// pass DataSources
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_8_0_1.model_8 childJob_tRunJob_9 = new demo_fay.model_8_0_1.model_8();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_9_0_1.model_9 childJob_tRunJob_10 = new demo_fay.model_9_0_1.model_9();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_10_0_1.model_10 childJob_tRunJob_11 = new demo_fay.model_10_0_1.model_10();
				// pass DataSources
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_11_0_1.model_11 childJob_tRunJob_12 = new demo_fay.model_11_0_1.model_11();
				// pass DataSources
	...
	public void tRunJob_13Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_12_0_1.model_12 childJob_tRunJob_13 = new demo_fay.model_12_0_1.model_12();
				// pass DataSources
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_13:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tRunJob_14Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_13_0_1.model_13 childJob_tRunJob_14 = new demo_fay.model_13_0_1.model_13();
				// pass DataSources
				...
				if (null != talendDataSources_tRunJob_14) {
					...
					for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_tRunJob_14 : talendDataSources_tRunJob_14
						...
						dataSources_tRunJob_14.put(
								talendDataSourceEntry_tRunJob_14.getKey(),
								talendDataSourceEntry_tRunJob_14.getValue()
										.getRawDataSource());
					}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_14:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_delta_0_1.model_delta childJob_tRunJob_1 = new demo_fay.model_delta_0_1.model_delta();
				// pass DataSources
	...
	public void tRunJob_17Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				demo_fay.model_vp_vul_0_1.model_vp_vul childJob_tRunJob_17 = new demo_fay.model_vp_vul_0_1.model_vp_vul();
				// pass DataSources
				...
				if (null != talendDataSources_tRunJob_17) {
					...
					for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_tRunJob_17 : talendDataSources_tRunJob_17
						...
						dataSources_tRunJob_17.put(
								talendDataSourceEntry_tRunJob_17.getKey(),
								talendDataSourceEntry_tRunJob_17.getValue()
										.getRawDataSource());
					}
	...
	public static void main(String[] args) {
		final models modelsClass = new models();

		int exitCode = modelsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = models.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/models_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : models");
		}
...
/************************************************************************************************
 * 123772 characters generated by Talend Open Studio for Data Integration on the
 * November 3, 2014 4:27:08 PM GMT
 ************************************************************************************************/
