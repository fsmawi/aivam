...
package demo_fay.model_vp_vul_0_1;
...
/**
 * Job: model_vp_vul Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class model_vp_vul implements TalendJob {
	...
	private final String jobName = "model_vp_vul";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(model_vp_vul.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_model_vp_vul = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_model_vp_vul = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_model_vp_vul.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_model_vp_vul.length == 0) {
						commonByteArray_DEMO_FAY_model_vp_vul = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_model_vp_vul = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_model_vp_vul, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_model_vp_vul,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_vp_vul) {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 27) {
							...
							if (rs_tMysqlInput_1.getObject(27) != null) {
								row1.id1 = rs_tMysqlInput_1.getInt(27);
							} else {
								row1.id1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							out1_tmp.segment = (row1.id1 != null) ? ((row1.type_vh == "VP") ? "Small High"
									: "VAN")
									: row1.segment;
	...
	public static void main(String[] args) {
		final model_vp_vul model_vp_vulClass = new model_vp_vul();

		int exitCode = model_vp_vulClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_vp_vul.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/model_vp_vul_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : model_vp_vul");
		}
...
/************************************************************************************************
 * 74337 characters generated by Talend Open Studio for Data Integration on the
