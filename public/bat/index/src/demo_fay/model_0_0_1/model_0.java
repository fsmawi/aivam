...
/**
 * Job: model_0 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class model_0 implements TalendJob {
	...
	private final String jobName = "model_0";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(model_0.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_model_0 = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_model_0 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_model_0.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_model_0.length == 0) {
						commonByteArray_DEMO_FAY_model_0 = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_model_0 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_model_0, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_model_0, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_0) {
	...
	public static class row1Struct implements
		...
		public String val_final;

		public String getVal_final() {
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.val_final, dos);
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 29) {
							...
							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(29);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.val_final = tmpContent_tMysqlInput_1;
							} else {
								row1.val_final = null;
							}
						}
						...
						{ // start of Var scope
							...
							out1_tmp.model_gnr = "0";
							out1_tmp.model = row1.val_final;
	...
	public static void main(String[] args) {
		final model_0 model_0Class = new model_0();

		int exitCode = model_0Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_0.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/model_0_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : model_0");
		}
...
/************************************************************************************************
 * 76807 characters generated by Talend Open Studio for Data Integration on the
