...
public class origine implements TalendJob {
	...
	public static class ttttStruct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_origine = new byte[0];
		static byte[] commonByteArray_AIVAM_origine = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_origine.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_origine.length == 0) {
						commonByteArray_AIVAM_origine = new byte[1024];
					} else {
						commonByteArray_AIVAM_origine = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_origine, 0, length);
				strReturn = new String(commonByteArray_AIVAM_origine, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_origine) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = origine.class.getClassLoader()
					.getResourceAsStream(
							"aivam/origine_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 74514 characters generated by Talend Open Studio for Data Integration on the
