...
public class model_0 implements TalendJob {
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_model_0 = new byte[0];
		static byte[] commonByteArray_AIVAM_model_0 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_model_0.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_model_0.length == 0) {
						commonByteArray_AIVAM_model_0 = new byte[1024];
					} else {
						commonByteArray_AIVAM_model_0 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_model_0, 0, length);
				strReturn = new String(commonByteArray_AIVAM_model_0, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_model_0) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_0.class.getClassLoader()
					.getResourceAsStream(
							"aivam/model_0_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 76602 characters generated by Talend Open Studio for Data Integration on the
