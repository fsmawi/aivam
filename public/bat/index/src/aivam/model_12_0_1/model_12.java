...
public class model_12 implements TalendJob {
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_model_12 = new byte[0];
		static byte[] commonByteArray_AIVAM_model_12 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_model_12.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_model_12.length == 0) {
						commonByteArray_AIVAM_model_12 = new byte[1024];
					} else {
						commonByteArray_AIVAM_model_12 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_model_12, 0, length);
				strReturn = new String(commonByteArray_AIVAM_model_12, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_model_12) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_12.class.getClassLoader()
					.getResourceAsStream(
							"aivam/model_12_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 133266 characters generated by Talend Open Studio for Data Integration on the
 * December 12, 2015 12:46:39 AM GMT
 ************************************************************************************************/
