...
package aivam.model_vp_vul_0_1;
...
public class model_vp_vul implements TalendJob {
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_model_vp_vul = new byte[0];
		static byte[] commonByteArray_AIVAM_model_vp_vul = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_model_vp_vul.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_model_vp_vul.length == 0) {
						commonByteArray_AIVAM_model_vp_vul = new byte[1024];
					} else {
						commonByteArray_AIVAM_model_vp_vul = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_model_vp_vul, 0, length);
				strReturn = new String(commonByteArray_AIVAM_model_vp_vul, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_model_vp_vul) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_vp_vul.class.getClassLoader()
					.getResourceAsStream(
							"aivam/model_vp_vul_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 74103 characters generated by Talend Open Studio for Data Integration on the
