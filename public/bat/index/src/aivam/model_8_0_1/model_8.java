...
public class model_8 implements TalendJob {
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_model_8 = new byte[0];
		static byte[] commonByteArray_AIVAM_model_8 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_model_8.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_model_8.length == 0) {
						commonByteArray_AIVAM_model_8 = new byte[1024];
					} else {
						commonByteArray_AIVAM_model_8 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_model_8, 0, length);
				strReturn = new String(commonByteArray_AIVAM_model_8, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_model_8) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_8.class.getClassLoader()
					.getResourceAsStream(
							"aivam/model_8_0_1/contexts/" + contextStr
									+ ".properties");
