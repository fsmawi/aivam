...
public class model_6 implements TalendJob {
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_model_6 = new byte[0];
		static byte[] commonByteArray_AIVAM_model_6 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_model_6.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_model_6.length == 0) {
						commonByteArray_AIVAM_model_6 = new byte[1024];
					} else {
						commonByteArray_AIVAM_model_6 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_model_6, 0, length);
				strReturn = new String(commonByteArray_AIVAM_model_6, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_model_6) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_6.class.getClassLoader()
					.getResourceAsStream(
							"aivam/model_6_0_1/contexts/" + contextStr
									+ ".properties");
