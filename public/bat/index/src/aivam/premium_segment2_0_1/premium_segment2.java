...
package aivam.premium_segment2_0_1;
...
/**
 * Job: premium_segment2 Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class premium_segment2 implements TalendJob {
	...
	private final String jobName = "premium_segment2";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					premium_segment2.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(premium_segment2.this, new Object[] { e,
	...
	public void tMysqlOutput_9_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_premium_segment2 = new byte[0];
		static byte[] commonByteArray_AIVAM_premium_segment2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_premium_segment2.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_premium_segment2.length == 0) {
						commonByteArray_AIVAM_premium_segment2 = new byte[1024];
					} else {
						commonByteArray_AIVAM_premium_segment2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_premium_segment2, 0, length);
				strReturn = new String(commonByteArray_AIVAM_premium_segment2,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_premium_segment2) {
	...
	public static class row1Struct implements
		...
		public String premium_segument1;

		public String getPremium_segument1() {
			return this.premium_segument1;
		}

		public String segument1;

		public String getSegument1() {
			return this.segument1;
		}

		public String body_type1;

		public String getBody_type1() {
			return this.body_type1;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_premium_segment2) {
				...
				try {
					...
					this.premium_segument1 = readString(dis);

					this.segument1 = readString(dis);

					this.body_type1 = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.premium_segument1, dos);

				// String

				writeString(this.segument1, dos);

				// String

				writeString(this.body_type1, dos);
		...
		public String toString() {
			...
			sb.append(",created_at=" + String.valueOf(created_at));
			sb.append(",updated_at=" + String.valueOf(updated_at));
			sb.append(",premium_segument1=" + premium_segument1);
			sb.append(",segument1=" + segument1);
			sb.append(",body_type1=" + body_type1);
			sb.append("]");
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_1 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_small_low`.premium_segument as 'premium_segument1',\r\n   `premium_segument_small_low`.segument as 'segument1',\r\n   `premium_segument_small_low`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_small_low` ON  `premium_segument_small_low`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n  'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 27) {
							row1.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(27);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.premium_segument1 = tmpContent_tMysqlInput_1;
							} else {
								row1.premium_segument1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 28) {
							...
							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(28);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.segument1 = tmpContent_tMysqlInput_1;
							} else {
								row1.segument1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 29) {
							row1.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(29);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.body_type1 = tmpContent_tMysqlInput_1;
							} else {
								row1.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							out1_tmp.premium_segment = row1.premium_segument1;
							out1_tmp.model_gnr = row1.model_gnr;
							out1_tmp.model = row1.model;
							out1_tmp.segment = row1.segument1;
							...
							out1_tmp.body_type = row1.body_type1;
	...
	public void tMysqlInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_2 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_small_high`.premium_segument as 'premium_segument1',\r\n   `premium_segument_small_high`.segument as 'segument1',\r\n   `premium_segument_small_high`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_small_high` ON  `premium_segument_small_high`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n \r\n  'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_2.next()) {
						...
						if (colQtyInRs_tMysqlInput_2 < 27) {
							row2.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_2 = rs_tMysqlInput_2
									.getString(27);
							if (tmpContent_tMysqlInput_2 != null) {
								row2.premium_segument1 = tmpContent_tMysqlInput_2;
							} else {
								row2.premium_segument1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_2 < 28) {
							...
							tmpContent_tMysqlInput_2 = rs_tMysqlInput_2
									.getString(28);
							if (tmpContent_tMysqlInput_2 != null) {
								row2.segument1 = tmpContent_tMysqlInput_2;
							} else {
								row2.segument1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_2 < 29) {
							row2.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_2 = rs_tMysqlInput_2
									.getString(29);
							if (tmpContent_tMysqlInput_2 != null) {
								row2.body_type1 = tmpContent_tMysqlInput_2;
							} else {
								row2.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfout1_tmp.premium_segment = row2.premium_segument1;
							copyOfout1_tmp.model_gnr = row2.model_gnr;
							copyOfout1_tmp.model = row2.model;
							copyOfout1_tmp.segment = row2.segument1;
							...
							copyOfout1_tmp.body_type = row2.body_type1;
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_3 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_medium`.premium_segument as 'premium_segument1',\r\n   `premium_segument_medium`.segument as 'segument1',\r\n   `premium_segument_medium`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_medium` ON  `premium_segument_medium`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n \r\n  'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_3.next()) {
						...
						if (colQtyInRs_tMysqlInput_3 < 27) {
							row3.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_3 = rs_tMysqlInput_3
									.getString(27);
							if (tmpContent_tMysqlInput_3 != null) {
								row3.premium_segument1 = tmpContent_tMysqlInput_3;
							} else {
								row3.premium_segument1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_3 < 28) {
							...
							tmpContent_tMysqlInput_3 = rs_tMysqlInput_3
									.getString(28);
							if (tmpContent_tMysqlInput_3 != null) {
								row3.segument1 = tmpContent_tMysqlInput_3;
							} else {
								row3.segument1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_3 < 29) {
							row3.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_3 = rs_tMysqlInput_3
									.getString(29);
							if (tmpContent_tMysqlInput_3 != null) {
								row3.body_type1 = tmpContent_tMysqlInput_3;
							} else {
								row3.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfout1_0_tmp.premium_segment = row3.premium_segument1;
							copyOfout1_0_tmp.model_gnr = row3.model_gnr;
							copyOfout1_0_tmp.model = row3.model;
							copyOfout1_0_tmp.segment = row3.segument1;
							...
							copyOfout1_0_tmp.body_type = row3.body_type1;
	...
	public void tMysqlInput_4Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_4 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_mpv`.premium_segument as 'premium_segument1',\r\n   `premium_segument_mpv`.segument as 'segument1',\r\n   `premium_segument_mpv`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_mpv` ON  `premium_segument_mpv`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n \r\n  'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_4.next()) {
						...
						if (colQtyInRs_tMysqlInput_4 < 27) {
							row4.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_4 = rs_tMysqlInput_4
									.getString(27);
							if (tmpContent_tMysqlInput_4 != null) {
								row4.premium_segument1 = tmpContent_tMysqlInput_4;
							} else {
								row4.premium_segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_4 < 28) {
							row4.segument1 = null;
						} else {
							...
							tmpContent_tMysqlInput_4 = rs_tMysqlInput_4
									.getString(28);
							if (tmpContent_tMysqlInput_4 != null) {
								row4.segument1 = tmpContent_tMysqlInput_4;
							} else {
								row4.segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_4 < 29) {
							row4.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_4 = rs_tMysqlInput_4
									.getString(29);
							if (tmpContent_tMysqlInput_4 != null) {
								row4.body_type1 = tmpContent_tMysqlInput_4;
							} else {
								row4.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfout1_1_tmp.premium_segment = row4.premium_segument1;
							copyOfout1_1_tmp.model_gnr = row4.model_gnr;
							copyOfout1_1_tmp.model = row4.model;
							copyOfout1_1_tmp.segment = row4.segument1;
							...
							copyOfout1_1_tmp.body_type = row4.body_type1;
	...
	public static class copyOfout1_2Struct implements
			routines.system.IPersistableRow<copyOfout1_2Struct> {
		final static byte[] commonByteArrayLock_AIVAM_premium_segment2 = new byte[0];
		static byte[] commonByteArray_AIVAM_premium_segment2 = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final copyOfout1_2Struct other = (copyOfout1_2Struct) obj;
		...
		public void copyDataTo(copyOfout1_2Struct other) {
		...
		public void copyKeysDataTo(copyOfout1_2Struct other) {
	...
	public void tMysqlInput_5Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_5 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_large`.premium_segument as 'premium_segument1',\r\n   `premium_segument_large`.segument as 'segument1',\r\n   `premium_segument_large`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_large` ON  `premium_segument_large`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n \r\n  'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_5.next()) {
						...
						if (colQtyInRs_tMysqlInput_5 < 27) {
							row5.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_5 = rs_tMysqlInput_5
									.getString(27);
							if (tmpContent_tMysqlInput_5 != null) {
								row5.premium_segument1 = tmpContent_tMysqlInput_5;
							} else {
								row5.premium_segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_5 < 28) {
							row5.segument1 = null;
						} else {
							...
							tmpContent_tMysqlInput_5 = rs_tMysqlInput_5
									.getString(28);
							if (tmpContent_tMysqlInput_5 != null) {
								row5.segument1 = tmpContent_tMysqlInput_5;
							} else {
								row5.segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_5 < 29) {
							row5.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_5 = rs_tMysqlInput_5
									.getString(29);
							if (tmpContent_tMysqlInput_5 != null) {
								row5.body_type1 = tmpContent_tMysqlInput_5;
							} else {
								row5.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfout1_2_tmp.id = row5.id;
							copyOfout1_2_tmp.year = row5.year;
							copyOfout1_2_tmp.month = row5.month;
							copyOfout1_2_tmp.city = row5.city;
							copyOfout1_2_tmp.group = row5.group;
							copyOfout1_2_tmp.make = row5.make;
							copyOfout1_2_tmp.premium_segment = row5.premium_segument1;
							copyOfout1_2_tmp.model_gnr = row5.model_gnr;
							copyOfout1_2_tmp.model = row5.model;
							copyOfout1_2_tmp.segment = row5.segument1;
							copyOfout1_2_tmp.ckd_cbu = row5.ckd_cbu;
							copyOfout1_2_tmp.pc_cv = row5.pc_cv;
							copyOfout1_2_tmp.engine_type = row5.engine_type;
							copyOfout1_2_tmp.type = row5.type;
							copyOfout1_2_tmp.displacement = row5.displacement;
							copyOfout1_2_tmp.sales = row5.sales;
							copyOfout1_2_tmp.origine = row5.origine;
							copyOfout1_2_tmp.body_type = (!row5.body_type1
									.equals("CAB/Coupe")) ? row5.body_type1
									: ((StringHandling.INDEX(row5.type,
											"CONVERTIBLE 2 PORTES") >= 0) ? "CAB"
											: "Coupe");
							copyOfout1_2_tmp.rsp = row5.rsp;
							copyOfout1_2_tmp.suv_type = row5.suv_type;
							copyOfout1_2_tmp.price_class = row5.price_class;
							copyOfout1_2_tmp.log_id = row5.log_id;
							copyOfout1_2_tmp.type_vh = row5.type_vh;
							copyOfout1_2_tmp.status = row5.status;
							copyOfout1_2_tmp.created_at = null;
							copyOfout1_2_tmp.updated_at = null;
						...
						if (copyOfout1_2 != null) {
							...
							pstmt_tMysqlOutput_5.setInt(1, copyOfout1_2.year);

							pstmt_tMysqlOutput_5.setInt(2, copyOfout1_2.month);

							if (copyOfout1_2.city == null) {
							...
							if (copyOfout1_2.premium_segment == null) {
								pstmt_tMysqlOutput_5.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(6,
										copyOfout1_2.premium_segment);
							}

							if (copyOfout1_2.model_gnr == null) {
								pstmt_tMysqlOutput_5.setNull(7,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(7,
										copyOfout1_2.model_gnr);
							}

							if (copyOfout1_2.model == null) {
							...
							if (copyOfout1_2.engine_type == null) {
								pstmt_tMysqlOutput_5.setNull(12,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(12,
										copyOfout1_2.engine_type);
							}

							if (copyOfout1_2.type == null) {
							...
							pstmt_tMysqlOutput_5.setInt(14,
									copyOfout1_2.displacement);

							pstmt_tMysqlOutput_5.setInt(15, copyOfout1_2.sales);

							if (copyOfout1_2.origine == null) {
								pstmt_tMysqlOutput_5.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(16,
										copyOfout1_2.origine);
							}

							if (copyOfout1_2.body_type == null) {
								pstmt_tMysqlOutput_5.setNull(17,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(17,
										copyOfout1_2.body_type);
							}

							pstmt_tMysqlOutput_5.setInt(18, copyOfout1_2.rsp);

							if (copyOfout1_2.suv_type == null) {
								pstmt_tMysqlOutput_5.setNull(19,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(19,
										copyOfout1_2.suv_type);
							}

							if (copyOfout1_2.price_class == null) {
								pstmt_tMysqlOutput_5.setNull(20,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(20,
										copyOfout1_2.price_class);
							}

							pstmt_tMysqlOutput_5
									.setInt(21, copyOfout1_2.log_id);

							if (copyOfout1_2.type_vh == null) {
								pstmt_tMysqlOutput_5.setNull(22,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_5.setString(22,
										copyOfout1_2.type_vh);
							}

							if (copyOfout1_2.status == null) {
	...
	public void tMysqlInput_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tMysqlInput_6 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_lux_large`.premium_segument as 'premium_segument1',\r\n   `premium_segument_lux_large`.segument as 'segument1',\r\n   `premium_segument_lux_large`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_lux_large` ON  `premium_segument_lux_large`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n   'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_6.next()) {
						...
						if (colQtyInRs_tMysqlInput_6 < 27) {
							row6.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_6 = rs_tMysqlInput_6
									.getString(27);
							if (tmpContent_tMysqlInput_6 != null) {
								row6.premium_segument1 = tmpContent_tMysqlInput_6;
							} else {
								row6.premium_segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_6 < 28) {
							row6.segument1 = null;
						} else {
							...
							tmpContent_tMysqlInput_6 = rs_tMysqlInput_6
									.getString(28);
							if (tmpContent_tMysqlInput_6 != null) {
								row6.segument1 = tmpContent_tMysqlInput_6;
							} else {
								row6.segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_6 < 29) {
							row6.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_6 = rs_tMysqlInput_6
									.getString(29);
							if (tmpContent_tMysqlInput_6 != null) {
								row6.body_type1 = tmpContent_tMysqlInput_6;
							} else {
								row6.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfcopyOfout1_1_tmp.id = row6.id;
							copyOfcopyOfout1_1_tmp.year = row6.year;
							copyOfcopyOfout1_1_tmp.month = row6.month;
							copyOfcopyOfout1_1_tmp.city = row6.city;
							copyOfcopyOfout1_1_tmp.group = row6.group;
							copyOfcopyOfout1_1_tmp.make = row6.make;
							copyOfcopyOfout1_1_tmp.premium_segment = row6.premium_segument1;
							copyOfcopyOfout1_1_tmp.model_gnr = row6.model_gnr;
							copyOfcopyOfout1_1_tmp.model = row6.model;
							copyOfcopyOfout1_1_tmp.segment = row6.segument1;
							copyOfcopyOfout1_1_tmp.ckd_cbu = row6.ckd_cbu;
							copyOfcopyOfout1_1_tmp.pc_cv = row6.pc_cv;
							copyOfcopyOfout1_1_tmp.engine_type = row6.engine_type;
							copyOfcopyOfout1_1_tmp.type = row6.type;
							copyOfcopyOfout1_1_tmp.displacement = row6.displacement;
							copyOfcopyOfout1_1_tmp.sales = row6.sales;
							copyOfcopyOfout1_1_tmp.origine = row6.origine;
							copyOfcopyOfout1_1_tmp.body_type = row6.body_type1;
							copyOfcopyOfout1_1_tmp.rsp = row6.rsp;
							copyOfcopyOfout1_1_tmp.suv_type = row6.suv_type;
							copyOfcopyOfout1_1_tmp.price_class = row6.price_class;
							copyOfcopyOfout1_1_tmp.log_id = row6.log_id;
							copyOfcopyOfout1_1_tmp.type_vh = row6.type_vh;
							copyOfcopyOfout1_1_tmp.status = row6.status;
						...
						if (copyOfcopyOfout1_1 != null) {
							...
							if (copyOfcopyOfout1_1.premium_segment == null) {
								...
								pstmt_tMysqlOutput_6.setString(6,
	...
	public static class copyOfcopyOfout1_1_0Struct implements
			routines.system.IPersistableRow<copyOfcopyOfout1_1_0Struct> {
		final static byte[] commonByteArrayLock_AIVAM_premium_segment2 = new byte[0];
		static byte[] commonByteArray_AIVAM_premium_segment2 = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final copyOfcopyOfout1_1_0Struct other = (copyOfcopyOfout1_1_0Struct) obj;
		...
		public void copyDataTo(copyOfcopyOfout1_1_0Struct other) {
		...
		public void copyKeysDataTo(copyOfcopyOfout1_1_0Struct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(copyOfcopyOfout1_1_0Struct other) {
	...
	public void tMysqlInput_7Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				copyOfcopyOfout1_1_0Struct copyOfcopyOfout1_1_0 = new copyOfcopyOfout1_1_0Struct();
				...
				// ###############################
				// # Outputs initialization
				copyOfcopyOfout1_1_0Struct copyOfcopyOfout1_1_0_tmp = new copyOfcopyOfout1_1_0Struct();
				// ###############################
				...
				String dbquery_tMysqlInput_7 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_lux_xlarge`.premium_segument as 'premium_segument1',\r\n   `premium_segument_lux_xlarge`.segument as 'segument1',\r\n   `premium_segument_lux_xlarge`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_lux_xlarge` ON  `premium_segument_lux_xlarge`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n  'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_7.next()) {
						...
						if (colQtyInRs_tMysqlInput_7 < 27) {
							row7.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_7 = rs_tMysqlInput_7
									.getString(27);
							if (tmpContent_tMysqlInput_7 != null) {
								row7.premium_segument1 = tmpContent_tMysqlInput_7;
							} else {
								row7.premium_segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_7 < 28) {
							row7.segument1 = null;
						} else {
							...
							tmpContent_tMysqlInput_7 = rs_tMysqlInput_7
									.getString(28);
							if (tmpContent_tMysqlInput_7 != null) {
								row7.segument1 = tmpContent_tMysqlInput_7;
							} else {
								row7.segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_7 < 29) {
							row7.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_7 = rs_tMysqlInput_7
									.getString(29);
							if (tmpContent_tMysqlInput_7 != null) {
								row7.body_type1 = tmpContent_tMysqlInput_7;
							} else {
								row7.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfcopyOfout1_1_0 = null;

							// # Output table : 'copyOfcopyOfout1_1_0'
							copyOfcopyOfout1_1_0_tmp.id = row7.id;
							copyOfcopyOfout1_1_0_tmp.year = row7.year;
							copyOfcopyOfout1_1_0_tmp.month = row7.month;
							copyOfcopyOfout1_1_0_tmp.city = row7.city;
							copyOfcopyOfout1_1_0_tmp.group = row7.group;
							copyOfcopyOfout1_1_0_tmp.make = row7.make;
							copyOfcopyOfout1_1_0_tmp.premium_segment = row7.premium_segument1;
							copyOfcopyOfout1_1_0_tmp.model_gnr = row7.model_gnr;
							copyOfcopyOfout1_1_0_tmp.model = row7.model;
							copyOfcopyOfout1_1_0_tmp.segment = row7.segument1;
							copyOfcopyOfout1_1_0_tmp.ckd_cbu = row7.ckd_cbu;
							copyOfcopyOfout1_1_0_tmp.pc_cv = row7.pc_cv;
							copyOfcopyOfout1_1_0_tmp.engine_type = row7.engine_type;
							copyOfcopyOfout1_1_0_tmp.type = row7.type;
							copyOfcopyOfout1_1_0_tmp.displacement = row7.displacement;
							copyOfcopyOfout1_1_0_tmp.sales = row7.sales;
							copyOfcopyOfout1_1_0_tmp.origine = row7.origine;
							copyOfcopyOfout1_1_0_tmp.body_type = row7.body_type1;
							copyOfcopyOfout1_1_0_tmp.rsp = row7.rsp;
							copyOfcopyOfout1_1_0_tmp.suv_type = row7.suv_type;
							copyOfcopyOfout1_1_0_tmp.price_class = row7.price_class;
							copyOfcopyOfout1_1_0_tmp.log_id = row7.log_id;
							copyOfcopyOfout1_1_0_tmp.type_vh = row7.type_vh;
							copyOfcopyOfout1_1_0_tmp.status = row7.status;
							copyOfcopyOfout1_1_0_tmp.created_at = null;
							copyOfcopyOfout1_1_0_tmp.updated_at = null;
							copyOfcopyOfout1_1_0 = copyOfcopyOfout1_1_0_tmp;
							// ###############################
						 ...
						 * [tMap_7 main ] stop
						 */
						// Start of branch "copyOfcopyOfout1_1_0"
						if (copyOfcopyOfout1_1_0 != null) {
							...
							pstmt_tMysqlOutput_7.setInt(1,
									copyOfcopyOfout1_1_0.year);

							pstmt_tMysqlOutput_7.setInt(2,
									copyOfcopyOfout1_1_0.month);

							if (copyOfcopyOfout1_1_0.city == null) {
								pstmt_tMysqlOutput_7.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(3,
										copyOfcopyOfout1_1_0.city);
							}

							if (copyOfcopyOfout1_1_0.group == null) {
								pstmt_tMysqlOutput_7.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(4,
										copyOfcopyOfout1_1_0.group);
							}

							if (copyOfcopyOfout1_1_0.make == null) {
								pstmt_tMysqlOutput_7.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(5,
										copyOfcopyOfout1_1_0.make);
							}

							if (copyOfcopyOfout1_1_0.premium_segment == null) {
								pstmt_tMysqlOutput_7.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(6,
										copyOfcopyOfout1_1_0.premium_segment);
							}

							if (copyOfcopyOfout1_1_0.model_gnr == null) {
								pstmt_tMysqlOutput_7.setNull(7,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(7,
										copyOfcopyOfout1_1_0.model_gnr);
							}

							if (copyOfcopyOfout1_1_0.model == null) {
								pstmt_tMysqlOutput_7.setNull(8,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(8,
										copyOfcopyOfout1_1_0.model);
							}

							if (copyOfcopyOfout1_1_0.segment == null) {
								pstmt_tMysqlOutput_7.setNull(9,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(9,
										copyOfcopyOfout1_1_0.segment);
							}

							if (copyOfcopyOfout1_1_0.ckd_cbu == null) {
								pstmt_tMysqlOutput_7.setNull(10,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(10,
										copyOfcopyOfout1_1_0.ckd_cbu);
							}

							if (copyOfcopyOfout1_1_0.pc_cv == null) {
								pstmt_tMysqlOutput_7.setNull(11,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(11,
										copyOfcopyOfout1_1_0.pc_cv);
							}

							if (copyOfcopyOfout1_1_0.engine_type == null) {
								pstmt_tMysqlOutput_7.setNull(12,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(12,
										copyOfcopyOfout1_1_0.engine_type);
							}

							if (copyOfcopyOfout1_1_0.type == null) {
								pstmt_tMysqlOutput_7.setNull(13,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(13,
										copyOfcopyOfout1_1_0.type);
							}

							pstmt_tMysqlOutput_7.setInt(14,
									copyOfcopyOfout1_1_0.displacement);

							pstmt_tMysqlOutput_7.setInt(15,
									copyOfcopyOfout1_1_0.sales);

							if (copyOfcopyOfout1_1_0.origine == null) {
								pstmt_tMysqlOutput_7.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(16,
										copyOfcopyOfout1_1_0.origine);
							}

							if (copyOfcopyOfout1_1_0.body_type == null) {
								pstmt_tMysqlOutput_7.setNull(17,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(17,
										copyOfcopyOfout1_1_0.body_type);
							}

							pstmt_tMysqlOutput_7.setInt(18,
									copyOfcopyOfout1_1_0.rsp);

							if (copyOfcopyOfout1_1_0.suv_type == null) {
								pstmt_tMysqlOutput_7.setNull(19,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(19,
										copyOfcopyOfout1_1_0.suv_type);
							}

							if (copyOfcopyOfout1_1_0.price_class == null) {
								pstmt_tMysqlOutput_7.setNull(20,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(20,
										copyOfcopyOfout1_1_0.price_class);
							}

							pstmt_tMysqlOutput_7.setInt(21,
									copyOfcopyOfout1_1_0.log_id);

							if (copyOfcopyOfout1_1_0.type_vh == null) {
								pstmt_tMysqlOutput_7.setNull(22,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(22,
										copyOfcopyOfout1_1_0.type_vh);
							}

							if (copyOfcopyOfout1_1_0.status == null) {
								pstmt_tMysqlOutput_7.setNull(23,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_7.setString(23,
										copyOfcopyOfout1_1_0.status);
							}

							if (copyOfcopyOfout1_1_0.created_at == null) {
								pstmt_tMysqlOutput_7.setNull(24,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_7.setInt(24,
										copyOfcopyOfout1_1_0.created_at);
							}

							if (copyOfcopyOfout1_1_0.updated_at == null) {
								pstmt_tMysqlOutput_7.setNull(25,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_7.setInt(25,
										copyOfcopyOfout1_1_0.updated_at);
							}

							pstmt_tMysqlOutput_7.setLong(
									26 + count_tMysqlOutput_7,
									copyOfcopyOfout1_1_0.id);
						...
						} // End of branch "copyOfcopyOfout1_1_0"
	...
	public static class copyOfcopyOfout1_1_1Struct implements
			routines.system.IPersistableRow<copyOfcopyOfout1_1_1Struct> {
		final static byte[] commonByteArrayLock_AIVAM_premium_segment2 = new byte[0];
		static byte[] commonByteArray_AIVAM_premium_segment2 = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final copyOfcopyOfout1_1_1Struct other = (copyOfcopyOfout1_1_1Struct) obj;
		...
		public void copyDataTo(copyOfcopyOfout1_1_1Struct other) {
		...
		public void copyKeysDataTo(copyOfcopyOfout1_1_1Struct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(copyOfcopyOfout1_1_1Struct other) {
	...
	public void tMysqlInput_8Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				copyOfcopyOfout1_1_1Struct copyOfcopyOfout1_1_1 = new copyOfcopyOfout1_1_1Struct();
				...
				String tableName_tMysqlOutput_8 = "items";
				...
				if (dbProperties_tMysqlOutput_8 == null
					...
					url_tMysqlOutput_8 = "jdbc:mysql://" + "localhost" + ":"
							+ "3306" + "/" + "aivam" + "?"
							+ "rewriteBatchedStatements=true";
				} else {
				...
				String dbUser_tMysqlOutput_8 = "root";

				final String decryptedPassword_tMysqlOutput_8 = routines.system.PasswordEncryptUtil
						.decryptPassword("");
				...
				String update_tMysqlOutput_8 = "UPDATE `"
						+ "items"
						+ "` SET `year` = ?,`month` = ?,`city` = ?,`group` = ?,`make` = ?,`premium_segment` = ?,`model_gnr` = ?,`model` = ?,`segment` = ?,`ckd_cbu` = ?,`pc_cv` = ?,`engine_type` = ?,`type` = ?,`displacement` = ?,`sales` = ?,`origine` = ?,`body_type` = ?,`rsp` = ?,`suv_type` = ?,`price_class` = ?,`log_id` = ?,`type_vh` = ?,`status` = ?,`created_at` = ?,`updated_at` = ? WHERE `id` = ?";

				java.sql.PreparedStatement pstmt_tMysqlOutput_8 = conn_tMysqlOutput_8
						.prepareStatement(update_tMysqlOutput_8);
				...
				// ###############################
				// # Outputs initialization
				copyOfcopyOfout1_1_1Struct copyOfcopyOfout1_1_1_tmp = new copyOfcopyOfout1_1_1Struct();
				// ###############################
				...
				final String decryptedPassword_tMysqlInput_8 = routines.system.PasswordEncryptUtil
						.decryptPassword("");
				String dbPwd_tMysqlInput_8 = decryptedPassword_tMysqlInput_8;

				String url_tMysqlInput_8 = "jdbc:mysql://" + "localhost" + ":"
						+ "3306" + "/" + "aivam" + "?"
						+ "noDatetimeStringSync=true";
				...
				String dbquery_tMysqlInput_8 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_suv`.premium_segument as 'premium_segument1',\r\n   `premium_segument_suv`.segument as 'segument1',\r\n   `premium_segument_suv`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_suv` ON  `premium_segument_suv`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n \r\n  'LAND ROVER','HUMMER')";
					...
					while (rs_tMysqlInput_8.next()) {
						...
						if (colQtyInRs_tMysqlInput_8 < 1) {
							...
							if (rs_tMysqlInput_8.getObject(1) != null) {
								row8.id = rs_tMysqlInput_8.getLong(1);
							} else {
						...
						if (colQtyInRs_tMysqlInput_8 < 2) {
							...
							if (rs_tMysqlInput_8.getObject(2) != null) {
								row8.year = rs_tMysqlInput_8.getInt(2);
							} else {
						...
						if (colQtyInRs_tMysqlInput_8 < 3) {
							...
							if (rs_tMysqlInput_8.getObject(3) != null) {
								row8.month = rs_tMysqlInput_8.getInt(3);
							} else {
						...
						if (colQtyInRs_tMysqlInput_8 < 4) {
							...
							if (tmpContent_tMysqlInput_8 != null) {
								row8.city = tmpContent_tMysqlInput_8;
							} else {
								row8.city = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 5) {
							row8.group = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(5);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.group = tmpContent_tMysqlInput_8;
							} else {
								row8.group = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 6) {
							row8.make = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(6);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.make = tmpContent_tMysqlInput_8;
							} else {
								row8.make = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 7) {
							row8.premium_segment = null;
						} else {

							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(7);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.premium_segment = tmpContent_tMysqlInput_8;
							} else {
								row8.premium_segment = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 8) {
							row8.model_gnr = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(8);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.model_gnr = tmpContent_tMysqlInput_8;
							} else {
								row8.model_gnr = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 9) {
							row8.model = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(9);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.model = tmpContent_tMysqlInput_8;
							} else {
								row8.model = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 10) {
							row8.segment = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(10);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.segment = tmpContent_tMysqlInput_8;
							} else {
								row8.segment = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 11) {
							row8.ckd_cbu = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(11);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.ckd_cbu = tmpContent_tMysqlInput_8;
							} else {
								row8.ckd_cbu = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 12) {
							row8.pc_cv = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(12);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.pc_cv = tmpContent_tMysqlInput_8;
							} else {
								row8.pc_cv = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 13) {
							row8.engine_type = null;
						} else {

							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(13);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.engine_type = tmpContent_tMysqlInput_8;
							} else {
								row8.engine_type = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 14) {
							row8.type = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(14);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.type = tmpContent_tMysqlInput_8;
							} else {
								row8.type = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 15) {
							row8.displacement = 0;
						} else {

							if (rs_tMysqlInput_8.getObject(15) != null) {
								row8.displacement = rs_tMysqlInput_8.getInt(15);
							} else {
						...
						if (colQtyInRs_tMysqlInput_8 < 16) {
							row8.sales = 0;
						} else {

							if (rs_tMysqlInput_8.getObject(16) != null) {
								row8.sales = rs_tMysqlInput_8.getInt(16);
							} else {
						...
						if (colQtyInRs_tMysqlInput_8 < 17) {
							row8.origine = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(17);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.origine = tmpContent_tMysqlInput_8;
							} else {
								row8.origine = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 18) {
							row8.body_type = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(18);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.body_type = tmpContent_tMysqlInput_8;
							} else {
								row8.body_type = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 19) {
							row8.rsp = 0;
						} else {

							if (rs_tMysqlInput_8.getObject(19) != null) {
								row8.rsp = rs_tMysqlInput_8.getInt(19);
							} else {
						...
						if (colQtyInRs_tMysqlInput_8 < 20) {
							row8.suv_type = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(20);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.suv_type = tmpContent_tMysqlInput_8;
							} else {
								row8.suv_type = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 21) {
							row8.price_class = null;
						} else {

							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(21);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.price_class = tmpContent_tMysqlInput_8;
							} else {
								row8.price_class = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 22) {
							row8.log_id = 0;
						} else {

							if (rs_tMysqlInput_8.getObject(22) != null) {
								row8.log_id = rs_tMysqlInput_8.getInt(22);
							} else {
						...
						if (colQtyInRs_tMysqlInput_8 < 23) {
							row8.type_vh = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(23);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.type_vh = tmpContent_tMysqlInput_8;
							} else {
								row8.type_vh = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 24) {
							row8.status = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(24);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.status = tmpContent_tMysqlInput_8;
							} else {
								row8.status = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 25) {
							row8.created_at = null;
						} else {

							if (rs_tMysqlInput_8.getObject(25) != null) {
								row8.created_at = rs_tMysqlInput_8.getInt(25);
							} else {
								row8.created_at = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 26) {
							row8.updated_at = null;
						} else {

							if (rs_tMysqlInput_8.getObject(26) != null) {
								row8.updated_at = rs_tMysqlInput_8.getInt(26);
							} else {
								row8.updated_at = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 27) {
							row8.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(27);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.premium_segument1 = tmpContent_tMysqlInput_8;
							} else {
								row8.premium_segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 28) {
							row8.segument1 = null;
						} else {
							...
							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(28);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.segument1 = tmpContent_tMysqlInput_8;
							} else {
								row8.segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_8 < 29) {
							row8.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_8 = rs_tMysqlInput_8
									.getString(29);
							if (tmpContent_tMysqlInput_8 != null) {
								row8.body_type1 = tmpContent_tMysqlInput_8;
							} else {
								row8.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfcopyOfout1_1_1 = null;

							// # Output table : 'copyOfcopyOfout1_1_1'
							copyOfcopyOfout1_1_1_tmp.id = row8.id;
							copyOfcopyOfout1_1_1_tmp.year = row8.year;
							copyOfcopyOfout1_1_1_tmp.month = row8.month;
							copyOfcopyOfout1_1_1_tmp.city = row8.city;
							copyOfcopyOfout1_1_1_tmp.group = row8.group;
							copyOfcopyOfout1_1_1_tmp.make = row8.make;
							copyOfcopyOfout1_1_1_tmp.premium_segment = row8.premium_segument1;
							copyOfcopyOfout1_1_1_tmp.model_gnr = row8.model_gnr;
							copyOfcopyOfout1_1_1_tmp.model = row8.model;
							copyOfcopyOfout1_1_1_tmp.segment = row8.segument1;
							copyOfcopyOfout1_1_1_tmp.ckd_cbu = row8.ckd_cbu;
							copyOfcopyOfout1_1_1_tmp.pc_cv = row8.pc_cv;
							copyOfcopyOfout1_1_1_tmp.engine_type = row8.engine_type;
							copyOfcopyOfout1_1_1_tmp.type = row8.type;
							copyOfcopyOfout1_1_1_tmp.displacement = row8.displacement;
							copyOfcopyOfout1_1_1_tmp.sales = row8.sales;
							copyOfcopyOfout1_1_1_tmp.origine = row8.origine;
							copyOfcopyOfout1_1_1_tmp.body_type = row8.body_type1;
							copyOfcopyOfout1_1_1_tmp.rsp = row8.rsp;
							copyOfcopyOfout1_1_1_tmp.suv_type = row8.suv_type;
							copyOfcopyOfout1_1_1_tmp.price_class = row8.price_class;
							copyOfcopyOfout1_1_1_tmp.log_id = row8.log_id;
							copyOfcopyOfout1_1_1_tmp.type_vh = row8.type_vh;
							copyOfcopyOfout1_1_1_tmp.status = row8.status;
							copyOfcopyOfout1_1_1_tmp.created_at = null;
							copyOfcopyOfout1_1_1_tmp.updated_at = null;
							copyOfcopyOfout1_1_1 = copyOfcopyOfout1_1_1_tmp;
							// ###############################
						 ...
						 * [tMap_8 main ] stop
						 */
						// Start of branch "copyOfcopyOfout1_1_1"
						if (copyOfcopyOfout1_1_1 != null) {
							...
							pstmt_tMysqlOutput_8.setInt(1,
									copyOfcopyOfout1_1_1.year);

							pstmt_tMysqlOutput_8.setInt(2,
									copyOfcopyOfout1_1_1.month);

							if (copyOfcopyOfout1_1_1.city == null) {
								pstmt_tMysqlOutput_8.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(3,
										copyOfcopyOfout1_1_1.city);
							}

							if (copyOfcopyOfout1_1_1.group == null) {
								pstmt_tMysqlOutput_8.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(4,
										copyOfcopyOfout1_1_1.group);
							}

							if (copyOfcopyOfout1_1_1.make == null) {
								pstmt_tMysqlOutput_8.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(5,
										copyOfcopyOfout1_1_1.make);
							}

							if (copyOfcopyOfout1_1_1.premium_segment == null) {
								pstmt_tMysqlOutput_8.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(6,
										copyOfcopyOfout1_1_1.premium_segment);
							}

							if (copyOfcopyOfout1_1_1.model_gnr == null) {
								pstmt_tMysqlOutput_8.setNull(7,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(7,
										copyOfcopyOfout1_1_1.model_gnr);
							}

							if (copyOfcopyOfout1_1_1.model == null) {
								pstmt_tMysqlOutput_8.setNull(8,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(8,
										copyOfcopyOfout1_1_1.model);
							}

							if (copyOfcopyOfout1_1_1.segment == null) {
								pstmt_tMysqlOutput_8.setNull(9,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(9,
										copyOfcopyOfout1_1_1.segment);
							}

							if (copyOfcopyOfout1_1_1.ckd_cbu == null) {
								pstmt_tMysqlOutput_8.setNull(10,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(10,
										copyOfcopyOfout1_1_1.ckd_cbu);
							}

							if (copyOfcopyOfout1_1_1.pc_cv == null) {
								pstmt_tMysqlOutput_8.setNull(11,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(11,
										copyOfcopyOfout1_1_1.pc_cv);
							}

							if (copyOfcopyOfout1_1_1.engine_type == null) {
								pstmt_tMysqlOutput_8.setNull(12,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(12,
										copyOfcopyOfout1_1_1.engine_type);
							}

							if (copyOfcopyOfout1_1_1.type == null) {
								pstmt_tMysqlOutput_8.setNull(13,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(13,
										copyOfcopyOfout1_1_1.type);
							}

							pstmt_tMysqlOutput_8.setInt(14,
									copyOfcopyOfout1_1_1.displacement);

							pstmt_tMysqlOutput_8.setInt(15,
									copyOfcopyOfout1_1_1.sales);

							if (copyOfcopyOfout1_1_1.origine == null) {
								pstmt_tMysqlOutput_8.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(16,
										copyOfcopyOfout1_1_1.origine);
							}

							if (copyOfcopyOfout1_1_1.body_type == null) {
								pstmt_tMysqlOutput_8.setNull(17,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(17,
										copyOfcopyOfout1_1_1.body_type);
							}

							pstmt_tMysqlOutput_8.setInt(18,
									copyOfcopyOfout1_1_1.rsp);

							if (copyOfcopyOfout1_1_1.suv_type == null) {
								pstmt_tMysqlOutput_8.setNull(19,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(19,
										copyOfcopyOfout1_1_1.suv_type);
							}

							if (copyOfcopyOfout1_1_1.price_class == null) {
								pstmt_tMysqlOutput_8.setNull(20,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(20,
										copyOfcopyOfout1_1_1.price_class);
							}

							pstmt_tMysqlOutput_8.setInt(21,
									copyOfcopyOfout1_1_1.log_id);

							if (copyOfcopyOfout1_1_1.type_vh == null) {
								pstmt_tMysqlOutput_8.setNull(22,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(22,
										copyOfcopyOfout1_1_1.type_vh);
							}

							if (copyOfcopyOfout1_1_1.status == null) {
								pstmt_tMysqlOutput_8.setNull(23,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_8.setString(23,
										copyOfcopyOfout1_1_1.status);
							}

							if (copyOfcopyOfout1_1_1.created_at == null) {
								pstmt_tMysqlOutput_8.setNull(24,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_8.setInt(24,
										copyOfcopyOfout1_1_1.created_at);
							}

							if (copyOfcopyOfout1_1_1.updated_at == null) {
								pstmt_tMysqlOutput_8.setNull(25,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_8.setInt(25,
										copyOfcopyOfout1_1_1.updated_at);
							}

							pstmt_tMysqlOutput_8.setLong(
									26 + count_tMysqlOutput_8,
									copyOfcopyOfout1_1_1.id);
							...
							if (batchSize_tMysqlOutput_8 <= batchSizeCounter_tMysqlOutput_8) {
								try {
									...
									for (int countEach_tMysqlOutput_8 : pstmt_tMysqlOutput_8
											.executeBatch()) {
										countSum_tMysqlOutput_8 += (countEach_tMysqlOutput_8 < 0 ? 0
												: countEach_tMysqlOutput_8);
									}
									...
									int countSum_tMysqlOutput_8 = 0;
									for (int countEach_tMysqlOutput_8 : e
											.getUpdateCounts()) {
										countSum_tMysqlOutput_8 += (countEach_tMysqlOutput_8 < 0 ? 0
												: countEach_tMysqlOutput_8);
									}
						...
						} // End of branch "copyOfcopyOfout1_1_1"
			...
			try {
				...
				if (resourceMap.get("finish_tMysqlOutput_8") == null) {
					if (resourceMap.get("conn_tMysqlOutput_8") != null) {
						try {
							((java.sql.Connection) resourceMap
									.get("conn_tMysqlOutput_8")).close();
						} catch (java.sql.SQLException sqlEx_tMysqlOutput_8) {
							System.out
									.println("failed to close the connection in tMysqlOutput_8 :"
											+ sqlEx_tMysqlOutput_8.getMessage());
						}
					}
				}
	...
	public static class copyOfcopyOfout1_1_2Struct implements
			routines.system.IPersistableRow<copyOfcopyOfout1_1_2Struct> {
		final static byte[] commonByteArrayLock_AIVAM_premium_segment2 = new byte[0];
		static byte[] commonByteArray_AIVAM_premium_segment2 = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final copyOfcopyOfout1_1_2Struct other = (copyOfcopyOfout1_1_2Struct) obj;
		...
		public void copyDataTo(copyOfcopyOfout1_1_2Struct other) {
		...
		public void copyKeysDataTo(copyOfcopyOfout1_1_2Struct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(copyOfcopyOfout1_1_2Struct other) {
	...
	public void tMysqlInput_9Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				copyOfcopyOfout1_1_2Struct copyOfcopyOfout1_1_2 = new copyOfcopyOfout1_1_2Struct();
				...
				int updateKeyCount_tMysqlOutput_9 = 1;
				if (updateKeyCount_tMysqlOutput_9 < 1) {
				...
				String tableName_tMysqlOutput_9 = "items";
				boolean whetherReject_tMysqlOutput_9 = false;

				java.util.Calendar calendar_tMysqlOutput_9 = java.util.Calendar
						.getInstance();
				calendar_tMysqlOutput_9.set(1, 0, 1, 0, 0, 0);
				long year1_tMysqlOutput_9 = calendar_tMysqlOutput_9.getTime()
						.getTime();
				calendar_tMysqlOutput_9.set(10000, 0, 1, 0, 0, 0);
				long year10000_tMysqlOutput_9 = calendar_tMysqlOutput_9
						.getTime().getTime();
				long date_tMysqlOutput_9;

				java.sql.Connection conn_tMysqlOutput_9 = null;
				String dbProperties_tMysqlOutput_9 = "noDatetimeStringSync=true";
				String url_tMysqlOutput_9 = null;
				if (dbProperties_tMysqlOutput_9 == null
						|| dbProperties_tMysqlOutput_9.trim().length() == 0) {
					url_tMysqlOutput_9 = "jdbc:mysql://" + "localhost" + ":"
							+ "3306" + "/" + "aivam" + "?"
							+ "rewriteBatchedStatements=true";
				} else {
					String properties_tMysqlOutput_9 = "noDatetimeStringSync=true";
					if (!properties_tMysqlOutput_9
							.contains("rewriteBatchedStatements")) {
						properties_tMysqlOutput_9 += "&rewriteBatchedStatements=true";
					}

					url_tMysqlOutput_9 = "jdbc:mysql://" + "localhost" + ":"
							+ "3306" + "/" + "aivam" + "?"
							+ properties_tMysqlOutput_9;
				}
				String dbUser_tMysqlOutput_9 = "root";

				final String decryptedPassword_tMysqlOutput_9 = routines.system.PasswordEncryptUtil
						.decryptPassword("");

				String dbPwd_tMysqlOutput_9 = decryptedPassword_tMysqlOutput_9;

				java.lang.Class.forName("org.gjt.mm.mysql.Driver");

				conn_tMysqlOutput_9 = java.sql.DriverManager.getConnection(
						url_tMysqlOutput_9, dbUser_tMysqlOutput_9,
						dbPwd_tMysqlOutput_9);

				resourceMap.put("conn_tMysqlOutput_9", conn_tMysqlOutput_9);
				conn_tMysqlOutput_9.setAutoCommit(false);
				int commitEvery_tMysqlOutput_9 = 10000;
				int commitCounter_tMysqlOutput_9 = 0;
				int batchSize_tMysqlOutput_9 = 10000;
				int batchSizeCounter_tMysqlOutput_9 = 0;

				int count_tMysqlOutput_9 = 0;

				String update_tMysqlOutput_9 = "UPDATE `"
						+ "items"
						+ "` SET `year` = ?,`month` = ?,`city` = ?,`group` = ?,`make` = ?,`premium_segment` = ?,`model_gnr` = ?,`model` = ?,`segment` = ?,`ckd_cbu` = ?,`pc_cv` = ?,`engine_type` = ?,`type` = ?,`displacement` = ?,`sales` = ?,`origine` = ?,`body_type` = ?,`rsp` = ?,`suv_type` = ?,`price_class` = ?,`log_id` = ?,`type_vh` = ?,`status` = ?,`created_at` = ?,`updated_at` = ? WHERE `id` = ?";

				java.sql.PreparedStatement pstmt_tMysqlOutput_9 = conn_tMysqlOutput_9
						.prepareStatement(update_tMysqlOutput_9);
				...
				// ###############################
				// # Outputs initialization
				copyOfcopyOfout1_1_2Struct copyOfcopyOfout1_1_2_tmp = new copyOfcopyOfout1_1_2Struct();
				// ###############################
				...
				java.lang.Class.forName("org.gjt.mm.mysql.Driver");
				String dbUser_tMysqlInput_9 = "root";

				final String decryptedPassword_tMysqlInput_9 = routines.system.PasswordEncryptUtil
						.decryptPassword("");
				String dbPwd_tMysqlInput_9 = decryptedPassword_tMysqlInput_9;

				String url_tMysqlInput_9 = "jdbc:mysql://" + "localhost" + ":"
						+ "3306" + "/" + "aivam" + "?"
						+ "noDatetimeStringSync=true";
				...
				String dbquery_tMysqlInput_9 = "SELECT \r\n  `items`.`id`, \r\n  `items`.`year`, \r\n  `items`.`month`, \r\n  `items`.`city`, \r\n  `items`.`group`, \r\n  `items`.`make`, \r\n  `items`.`premium_segment`, \r\n  `items`.`model_gnr`, \r\n  `items`.`model`, \r\n  `items`.`segment`, \r\n  `items`.`ckd_cbu`, \r\n  `items`.`pc_cv`, \r\n  `items`.`engine_type`, \r\n  `items`.`type`, \r\n  `items`.`displacement`, \r\n  `items`.`sales`, \r\n  `items`.`origine`, \r\n  `items`.`body_type`, \r\n  `items`.`rsp`, \r\n  `items`.`suv_type`, \r\n  `items`.`price_class`, \r\n  `items`.`log_id`, \r\n  `items`.`type_vh`, \r\n  `items`.`status`, \r\n  `items`.`created_at`, \r\n  `items`.`updated_at`,\r\n   `premium_segument_lux_suv`.premium_segument as 'premium_segument1',\r\n   `premium_segument_lux_suv`.segument as 'segument1',\r\n   `premium_segument_lux_suv`.body_type as 'body_type1'\r\nFROM `items`\r\nINNER JOIN `premium_segument_lux_suv` ON  `premium_segument_lux_suv`.model = items.model\r\nWHERE  `items`.`make` IN ('AUDI', 'BMW', 'MERCEDES', 'JAGUAR', 'LEXUS', 'VOLVO', 'PORSCHE', 'MINI',\n \r\n  'LAND ROVER','HUMMER')";
				...
				try {
					...
					while (rs_tMysqlInput_9.next()) {
						...
						if (colQtyInRs_tMysqlInput_9 < 1) {
							...
							if (rs_tMysqlInput_9.getObject(1) != null) {
								row9.id = rs_tMysqlInput_9.getLong(1);
							} else {
						...
						if (colQtyInRs_tMysqlInput_9 < 2) {
							...
							if (rs_tMysqlInput_9.getObject(2) != null) {
								row9.year = rs_tMysqlInput_9.getInt(2);
							} else {
						...
						if (colQtyInRs_tMysqlInput_9 < 3) {
							...
							if (rs_tMysqlInput_9.getObject(3) != null) {
								row9.month = rs_tMysqlInput_9.getInt(3);
							} else {
						...
						if (colQtyInRs_tMysqlInput_9 < 4) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(4);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.city = tmpContent_tMysqlInput_9;
							} else {
								row9.city = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 5) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(5);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.group = tmpContent_tMysqlInput_9;
							} else {
								row9.group = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 6) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(6);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.make = tmpContent_tMysqlInput_9;
							} else {
								row9.make = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 7) {
							row9.premium_segment = null;
						} else {

							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(7);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.premium_segment = tmpContent_tMysqlInput_9;
							} else {
								row9.premium_segment = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 8) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(8);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.model_gnr = tmpContent_tMysqlInput_9;
							} else {
								row9.model_gnr = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 9) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(9);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.model = tmpContent_tMysqlInput_9;
							} else {
								row9.model = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 10) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(10);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.segment = tmpContent_tMysqlInput_9;
							} else {
								row9.segment = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 11) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(11);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.ckd_cbu = tmpContent_tMysqlInput_9;
							} else {
								row9.ckd_cbu = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 12) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(12);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.pc_cv = tmpContent_tMysqlInput_9;
							} else {
								row9.pc_cv = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 13) {
							row9.engine_type = null;
						} else {

							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(13);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.engine_type = tmpContent_tMysqlInput_9;
							} else {
								row9.engine_type = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 14) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(14);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.type = tmpContent_tMysqlInput_9;
							} else {
								row9.type = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 15) {
							...
							if (rs_tMysqlInput_9.getObject(15) != null) {
								row9.displacement = rs_tMysqlInput_9.getInt(15);
							} else {
						...
						if (colQtyInRs_tMysqlInput_9 < 16) {
							...
							if (rs_tMysqlInput_9.getObject(16) != null) {
								row9.sales = rs_tMysqlInput_9.getInt(16);
							} else {
						...
						if (colQtyInRs_tMysqlInput_9 < 17) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(17);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.origine = tmpContent_tMysqlInput_9;
							} else {
								row9.origine = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_9 < 18) {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(18);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.body_type = tmpContent_tMysqlInput_9;
							} else {
								row9.body_type = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 19) {
							row9.rsp = 0;
						} else {

							if (rs_tMysqlInput_9.getObject(19) != null) {
								row9.rsp = rs_tMysqlInput_9.getInt(19);
							} else {
						...
						if (colQtyInRs_tMysqlInput_9 < 20) {
							row9.suv_type = null;
						} else {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(20);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.suv_type = tmpContent_tMysqlInput_9;
							} else {
								row9.suv_type = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 21) {
							row9.price_class = null;
						} else {

							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(21);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.price_class = tmpContent_tMysqlInput_9;
							} else {
								row9.price_class = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 22) {
							row9.log_id = 0;
						} else {

							if (rs_tMysqlInput_9.getObject(22) != null) {
								row9.log_id = rs_tMysqlInput_9.getInt(22);
							} else {
						...
						if (colQtyInRs_tMysqlInput_9 < 23) {
							row9.type_vh = null;
						} else {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(23);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.type_vh = tmpContent_tMysqlInput_9;
							} else {
								row9.type_vh = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 24) {
							row9.status = null;
						} else {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(24);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.status = tmpContent_tMysqlInput_9;
							} else {
								row9.status = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 25) {
							row9.created_at = null;
						} else {

							if (rs_tMysqlInput_9.getObject(25) != null) {
								row9.created_at = rs_tMysqlInput_9.getInt(25);
							} else {
								row9.created_at = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 26) {
							row9.updated_at = null;
						} else {

							if (rs_tMysqlInput_9.getObject(26) != null) {
								row9.updated_at = rs_tMysqlInput_9.getInt(26);
							} else {
								row9.updated_at = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 27) {
							row9.premium_segument1 = null;
						} else {

							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(27);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.premium_segument1 = tmpContent_tMysqlInput_9;
							} else {
								row9.premium_segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 28) {
							row9.segument1 = null;
						} else {
							...
							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(28);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.segument1 = tmpContent_tMysqlInput_9;
							} else {
								row9.segument1 = null;
							}
						}

						if (colQtyInRs_tMysqlInput_9 < 29) {
							row9.body_type1 = null;
						} else {

							tmpContent_tMysqlInput_9 = rs_tMysqlInput_9
									.getString(29);
							if (tmpContent_tMysqlInput_9 != null) {
								row9.body_type1 = tmpContent_tMysqlInput_9;
							} else {
								row9.body_type1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfcopyOfout1_1_2 = null;

							// # Output table : 'copyOfcopyOfout1_1_2'
							copyOfcopyOfout1_1_2_tmp.id = row9.id;
							copyOfcopyOfout1_1_2_tmp.year = row9.year;
							copyOfcopyOfout1_1_2_tmp.month = row9.month;
							copyOfcopyOfout1_1_2_tmp.city = row9.city;
							copyOfcopyOfout1_1_2_tmp.group = row9.group;
							copyOfcopyOfout1_1_2_tmp.make = row9.make;
							copyOfcopyOfout1_1_2_tmp.premium_segment = row9.premium_segument1;
							copyOfcopyOfout1_1_2_tmp.model_gnr = row9.model_gnr;
							copyOfcopyOfout1_1_2_tmp.model = row9.model;
							copyOfcopyOfout1_1_2_tmp.segment = row9.segument1;
							copyOfcopyOfout1_1_2_tmp.ckd_cbu = row9.ckd_cbu;
							copyOfcopyOfout1_1_2_tmp.pc_cv = row9.pc_cv;
							copyOfcopyOfout1_1_2_tmp.engine_type = row9.engine_type;
							copyOfcopyOfout1_1_2_tmp.type = row9.type;
							copyOfcopyOfout1_1_2_tmp.displacement = row9.displacement;
							copyOfcopyOfout1_1_2_tmp.sales = row9.sales;
							copyOfcopyOfout1_1_2_tmp.origine = row9.origine;
							copyOfcopyOfout1_1_2_tmp.body_type = row9.body_type1;
							copyOfcopyOfout1_1_2_tmp.rsp = row9.rsp;
							copyOfcopyOfout1_1_2_tmp.suv_type = row9.suv_type;
							copyOfcopyOfout1_1_2_tmp.price_class = row9.price_class;
							copyOfcopyOfout1_1_2_tmp.log_id = row9.log_id;
							copyOfcopyOfout1_1_2_tmp.type_vh = row9.type_vh;
							copyOfcopyOfout1_1_2_tmp.status = row9.status;
							copyOfcopyOfout1_1_2_tmp.created_at = null;
							copyOfcopyOfout1_1_2_tmp.updated_at = null;
							copyOfcopyOfout1_1_2 = copyOfcopyOfout1_1_2_tmp;
							// ###############################
						 ...
						 * [tMap_9 main ] stop
						 */
						// Start of branch "copyOfcopyOfout1_1_2"
						if (copyOfcopyOfout1_1_2 != null) {
							...
							pstmt_tMysqlOutput_9.setInt(1,
									copyOfcopyOfout1_1_2.year);

							pstmt_tMysqlOutput_9.setInt(2,
									copyOfcopyOfout1_1_2.month);

							if (copyOfcopyOfout1_1_2.city == null) {
								pstmt_tMysqlOutput_9.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(3,
										copyOfcopyOfout1_1_2.city);
							}

							if (copyOfcopyOfout1_1_2.group == null) {
								pstmt_tMysqlOutput_9.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(4,
										copyOfcopyOfout1_1_2.group);
							}

							if (copyOfcopyOfout1_1_2.make == null) {
								pstmt_tMysqlOutput_9.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(5,
										copyOfcopyOfout1_1_2.make);
							}

							if (copyOfcopyOfout1_1_2.premium_segment == null) {
								pstmt_tMysqlOutput_9.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(6,
										copyOfcopyOfout1_1_2.premium_segment);
							}

							if (copyOfcopyOfout1_1_2.model_gnr == null) {
								pstmt_tMysqlOutput_9.setNull(7,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(7,
										copyOfcopyOfout1_1_2.model_gnr);
							}

							if (copyOfcopyOfout1_1_2.model == null) {
								pstmt_tMysqlOutput_9.setNull(8,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(8,
										copyOfcopyOfout1_1_2.model);
							}

							if (copyOfcopyOfout1_1_2.segment == null) {
								pstmt_tMysqlOutput_9.setNull(9,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(9,
										copyOfcopyOfout1_1_2.segment);
							}

							if (copyOfcopyOfout1_1_2.ckd_cbu == null) {
								pstmt_tMysqlOutput_9.setNull(10,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(10,
										copyOfcopyOfout1_1_2.ckd_cbu);
							}

							if (copyOfcopyOfout1_1_2.pc_cv == null) {
								pstmt_tMysqlOutput_9.setNull(11,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(11,
										copyOfcopyOfout1_1_2.pc_cv);
							}

							if (copyOfcopyOfout1_1_2.engine_type == null) {
								pstmt_tMysqlOutput_9.setNull(12,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(12,
										copyOfcopyOfout1_1_2.engine_type);
							}

							if (copyOfcopyOfout1_1_2.type == null) {
								pstmt_tMysqlOutput_9.setNull(13,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(13,
										copyOfcopyOfout1_1_2.type);
							}

							pstmt_tMysqlOutput_9.setInt(14,
									copyOfcopyOfout1_1_2.displacement);

							pstmt_tMysqlOutput_9.setInt(15,
									copyOfcopyOfout1_1_2.sales);

							if (copyOfcopyOfout1_1_2.origine == null) {
								pstmt_tMysqlOutput_9.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(16,
										copyOfcopyOfout1_1_2.origine);
							}

							if (copyOfcopyOfout1_1_2.body_type == null) {
								pstmt_tMysqlOutput_9.setNull(17,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(17,
										copyOfcopyOfout1_1_2.body_type);
							}

							pstmt_tMysqlOutput_9.setInt(18,
									copyOfcopyOfout1_1_2.rsp);

							if (copyOfcopyOfout1_1_2.suv_type == null) {
								pstmt_tMysqlOutput_9.setNull(19,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(19,
										copyOfcopyOfout1_1_2.suv_type);
							}

							if (copyOfcopyOfout1_1_2.price_class == null) {
								pstmt_tMysqlOutput_9.setNull(20,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(20,
										copyOfcopyOfout1_1_2.price_class);
							}

							pstmt_tMysqlOutput_9.setInt(21,
									copyOfcopyOfout1_1_2.log_id);

							if (copyOfcopyOfout1_1_2.type_vh == null) {
								pstmt_tMysqlOutput_9.setNull(22,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(22,
										copyOfcopyOfout1_1_2.type_vh);
							}

							if (copyOfcopyOfout1_1_2.status == null) {
								pstmt_tMysqlOutput_9.setNull(23,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_9.setString(23,
										copyOfcopyOfout1_1_2.status);
							}

							if (copyOfcopyOfout1_1_2.created_at == null) {
								pstmt_tMysqlOutput_9.setNull(24,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_9.setInt(24,
										copyOfcopyOfout1_1_2.created_at);
							}

							if (copyOfcopyOfout1_1_2.updated_at == null) {
								pstmt_tMysqlOutput_9.setNull(25,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_9.setInt(25,
										copyOfcopyOfout1_1_2.updated_at);
							}

							pstmt_tMysqlOutput_9.setLong(
									26 + count_tMysqlOutput_9,
									copyOfcopyOfout1_1_2.id);

							pstmt_tMysqlOutput_9.addBatch();
							nb_line_tMysqlOutput_9++;

							batchSizeCounter_tMysqlOutput_9++;

							if (batchSize_tMysqlOutput_9 <= batchSizeCounter_tMysqlOutput_9) {
								try {
									int countSum_tMysqlOutput_9 = 0;
									for (int countEach_tMysqlOutput_9 : pstmt_tMysqlOutput_9
											.executeBatch()) {
										countSum_tMysqlOutput_9 += (countEach_tMysqlOutput_9 < 0 ? 0
												: countEach_tMysqlOutput_9);
									}

									updatedCount_tMysqlOutput_9 += countSum_tMysqlOutput_9;

									batchSizeCounter_tMysqlOutput_9 = 0;
								} catch (java.sql.BatchUpdateException e) {

									int countSum_tMysqlOutput_9 = 0;
									for (int countEach_tMysqlOutput_9 : e
											.getUpdateCounts()) {
										countSum_tMysqlOutput_9 += (countEach_tMysqlOutput_9 < 0 ? 0
												: countEach_tMysqlOutput_9);
									}
							...
							commitCounter_tMysqlOutput_9++;

							if (commitEvery_tMysqlOutput_9 <= commitCounter_tMysqlOutput_9) {
								...
								conn_tMysqlOutput_9.commit();

								commitCounter_tMysqlOutput_9 = 0;
						...
						} // End of branch "copyOfcopyOfout1_1_2"
				...
				try {
					...
					int countSum_tMysqlOutput_9 = 0;
					for (int countEach_tMysqlOutput_9 : e.getUpdateCounts()) {
						countSum_tMysqlOutput_9 += (countEach_tMysqlOutput_9 < 0 ? 0
								: countEach_tMysqlOutput_9);
					}
				...
				conn_tMysqlOutput_9.close();
				resourceMap.put("finish_tMysqlOutput_9", true);

				nb_line_deleted_tMysqlOutput_9 = nb_line_deleted_tMysqlOutput_9
						+ deletedCount_tMysqlOutput_9;
				nb_line_update_tMysqlOutput_9 = nb_line_update_tMysqlOutput_9
						+ updatedCount_tMysqlOutput_9;
				nb_line_inserted_tMysqlOutput_9 = nb_line_inserted_tMysqlOutput_9
						+ insertedCount_tMysqlOutput_9;
				nb_line_rejected_tMysqlOutput_9 = nb_line_rejected_tMysqlOutput_9
						+ rejectedCount_tMysqlOutput_9;
				globalMap.put("tMysqlOutput_9_NB_LINE", nb_line_tMysqlOutput_9);
				globalMap.put("tMysqlOutput_9_NB_LINE_UPDATED",
						nb_line_update_tMysqlOutput_9);
				globalMap.put("tMysqlOutput_9_NB_LINE_INSERTED",
						nb_line_inserted_tMysqlOutput_9);
				globalMap.put("tMysqlOutput_9_NB_LINE_DELETED",
						nb_line_deleted_tMysqlOutput_9);
				globalMap.put("tMysqlOutput_9_NB_LINE_REJECTED",
						nb_line_rejected_tMysqlOutput_9);
			...
			try {
				...
				if (resourceMap.get("finish_tMysqlOutput_9") == null) {
					if (resourceMap.get("conn_tMysqlOutput_9") != null) {
						try {
							((java.sql.Connection) resourceMap
									.get("conn_tMysqlOutput_9")).close();
						} catch (java.sql.SQLException sqlEx_tMysqlOutput_9) {
							System.out
									.println("failed to close the connection in tMysqlOutput_9 :"
											+ sqlEx_tMysqlOutput_9.getMessage());
						}
					}
				}
	...
	public static void main(String[] args) {
		final premium_segment2 premium_segment2Class = new premium_segment2();

		int exitCode = premium_segment2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = premium_segment2.class
					.getClassLoader().getResourceAsStream(
							"aivam/premium_segment2_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : premium_segment2");
		}
...
/************************************************************************************************
 * 551898 characters generated by Talend Open Studio for Data Integration on the
 * December 12, 2015 12:46:42 AM GMT
 ************************************************************************************************/
