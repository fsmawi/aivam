...
public class group implements TalendJob {
	...
	public static class testStruct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_group = new byte[0];
		static byte[] commonByteArray_AIVAM_group = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_group.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_group.length == 0) {
						commonByteArray_AIVAM_group = new byte[1024];
					} else {
						commonByteArray_AIVAM_group = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_group, 0, length);
				strReturn = new String(commonByteArray_AIVAM_group, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_group) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = group.class.getClassLoader()
					.getResourceAsStream(
							"aivam/group_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 74423 characters generated by Talend Open Studio for Data Integration on the
