...
package aivam.main_process_0_1;
...
public class main_process implements TalendJob {
	...
	public static class copyOfout02Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_main_process = new byte[0];
		static byte[] commonByteArray_AIVAM_main_process = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_main_process.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_main_process.length == 0) {
						commonByteArray_AIVAM_main_process = new byte[1024];
					} else {
						commonByteArray_AIVAM_main_process = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_main_process, 0, length);
				strReturn = new String(commonByteArray_AIVAM_main_process, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_main_process) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main_process.class.getClassLoader()
					.getResourceAsStream(
							"aivam/main_process_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 139595 characters generated by Talend Open Studio for Data Integration on the
 * December 12, 2015 12:46:34 AM GMT
 ************************************************************************************************/
