	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				aivam.main_process_0_1.main_process childJob_tRunJob_1 = new aivam.main_process_0_1.main_process();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				aivam.models_0_1.models childJob_tRunJob_2 = new aivam.models_0_1.models();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				aivam.premium_segment2_0_1.premium_segment2 childJob_tRunJob_3 = new aivam.premium_segment2_0_1.premium_segment2();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				aivam.premium_sport_0_1.premium_sport childJob_tRunJob_6 = new aivam.premium_sport_0_1.premium_sport();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				aivam.origine_0_1.origine childJob_tRunJob_4 = new aivam.origine_0_1.origine();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				aivam.group_0_1.group childJob_tRunJob_5 = new aivam.group_0_1.group();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = index.class.getClassLoader()
					.getResourceAsStream(
							"aivam/index_0_1/contexts/" + contextStr
									+ ".properties");
 ...
 * December 12, 2015 12:46:43 AM GMT
 ************************************************************************************************/
