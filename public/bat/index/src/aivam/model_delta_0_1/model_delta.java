...
public class model_delta implements TalendJob {
	...
	public static class copyOfout1Struct implements
		...
		final static byte[] commonByteArrayLock_AIVAM_model_delta = new byte[0];
		static byte[] commonByteArray_AIVAM_model_delta = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AIVAM_model_delta.length) {
					if (length < 1024
							&& commonByteArray_AIVAM_model_delta.length == 0) {
						commonByteArray_AIVAM_model_delta = new byte[1024];
					} else {
						commonByteArray_AIVAM_model_delta = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AIVAM_model_delta, 0, length);
				strReturn = new String(commonByteArray_AIVAM_model_delta, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AIVAM_model_delta) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_delta.class.getClassLoader()
					.getResourceAsStream(
							"aivam/model_delta_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 127730 characters generated by Talend Open Studio for Data Integration on the
 * December 12, 2015 12:46:40 AM GMT
 ************************************************************************************************/
