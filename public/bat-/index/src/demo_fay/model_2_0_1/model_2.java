...
/**
 * Job: model_2 Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 5.5.1.r118616
 * @status 
 */
public class model_2 implements TalendJob {
	...
	private final String jobName = "model_2";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(model_2.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_model_2 = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_model_2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_model_2.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_model_2.length == 0) {
						commonByteArray_DEMO_FAY_model_2 = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_model_2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_model_2, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_model_2, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_2) {
	...
	public static class row1Struct implements
		...
		public String segument;

		public String getSegument() {
			return this.segument;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_2) {
				...
				try {
					...
					this.model1 = readString(dis);

					this.segument = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.model1, dos);

				// String

				writeString(this.segument, dos);
		...
		public String toString() {
			...
			sb.append(",model1=" + model1);
			sb.append(",segument=" + segument);
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 29) {
							...
							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(29);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.marque = tmpContent_tMysqlInput_1;
							} else {
								row1.marque = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 30) {
							...
							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(30);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.model1 = tmpContent_tMysqlInput_1;
							} else {
								row1.model1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 31) {
							...
							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(31);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.segument = tmpContent_tMysqlInput_1;
							} else {
								row1.segument = null;
							}
						}
						...
						{ // start of Var scope
							...
							out1_tmp.segment = row1.segument;
							...
							out1_tmp.body_type = (row1.nb_portes == 5) ? "HB"
									: ((row1.nb_portes == 4) ? "SD" : "check");
						...
						if (out1 != null) {
							...
							pstmt_tMysqlOutput_1.setLong(1, out1.id);

							pstmt_tMysqlOutput_1.setInt(2, out1.year);

							pstmt_tMysqlOutput_1.setInt(3, out1.month);

							if (out1.city == null) {
								pstmt_tMysqlOutput_1.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(4, out1.city);
							}
							...
							if (out1.group == null) {
								...
								pstmt_tMysqlOutput_1.setString(5, out1.group);
							}
							...
							if (out1.make == null) {
								...
								pstmt_tMysqlOutput_1.setString(6, out1.make);
							}
							...
							if (out1.model == null) {
								...
								pstmt_tMysqlOutput_1.setString(9, out1.model);
							}
							...
							if (out1.pc_cv == null) {
								...
								pstmt_tMysqlOutput_1.setString(12, out1.pc_cv);
							}
							...
							if (out1.type == null) {
								...
								pstmt_tMysqlOutput_1.setString(14, out1.type);
							}

							pstmt_tMysqlOutput_1.setInt(15, out1.displacement);

							pstmt_tMysqlOutput_1.setInt(16, out1.sales);
							...
							pstmt_tMysqlOutput_1.setInt(19, out1.rsp);
							...
							pstmt_tMysqlOutput_1.setInt(22, out1.log_id);
							...
							if (out1.status == null) {
								...
								pstmt_tMysqlOutput_1.setString(24, out1.status);
							}
	...
	public void tMysqlInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String delete_tMysqlOutput_2 = "DELETE  FROM `" + "items_temp"
						+ "` WHERE `id` = ?";
				...
				try {
					...
					while (rs_tMysqlInput_2.next()) {
						...
						if (colQtyInRs_tMysqlInput_2 < 27) {
							...
							if (rs_tMysqlInput_2.getObject(27) != null) {
								row2.nb_portes = rs_tMysqlInput_2.getInt(27);
							} else {
								row2.nb_portes = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_2 < 28) {
							...
							if (rs_tMysqlInput_2.getObject(28) != null) {
								row2.nb_places = rs_tMysqlInput_2.getInt(28);
							} else {
								row2.nb_places = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_2 < 29) {
							...
							tmpContent_tMysqlInput_2 = rs_tMysqlInput_2
									.getString(29);
							if (tmpContent_tMysqlInput_2 != null) {
								row2.marque = tmpContent_tMysqlInput_2;
							} else {
								row2.marque = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_2 < 30) {
							...
							tmpContent_tMysqlInput_2 = rs_tMysqlInput_2
									.getString(30);
							if (tmpContent_tMysqlInput_2 != null) {
								row2.model1 = tmpContent_tMysqlInput_2;
							} else {
								row2.model1 = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_2 < 31) {
							...
							tmpContent_tMysqlInput_2 = rs_tMysqlInput_2
									.getString(31);
							if (tmpContent_tMysqlInput_2 != null) {
								row2.segument = tmpContent_tMysqlInput_2;
							} else {
								row2.segument = null;
							}
						}
						...
						{ // start of Var scope
							...
							copyOfout1_tmp.premium_segment = row2.premium_segment;
							copyOfout1_tmp.model_gnr = row2.model_gnr;
							copyOfout1_tmp.model = row2.model;
							copyOfout1_tmp.segment = row2.segument;
							...
							copyOfout1_tmp.nb_portes = null;
							copyOfout1_tmp.nb_places = null;
						...
						if (copyOfout1 != null) {
							...
							pstmt_tMysqlOutput_2.setLong(1, copyOfout1.id);
	...
	public static void main(String[] args) {
		final model_2 model_2Class = new model_2();

		int exitCode = model_2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_2.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/model_2_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : model_2");
		}
...
/************************************************************************************************
 * 136321 characters generated by Talend Open Studio for Data Integration on the
 * November 28, 2015 11:41:05 PM GMT
 ************************************************************************************************/
