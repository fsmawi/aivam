...
/**
 * Job: origine Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class origine implements TalendJob {
	...
	private final String jobName = "origine";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(origine.this, new Object[] { e,
	...
	public static class ttttStruct implements
			routines.system.IPersistableRow<ttttStruct> {
		final static byte[] commonByteArrayLock_DEMO_FAY_origine = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_origine = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final ttttStruct other = (ttttStruct) obj;
		...
		public void copyDataTo(ttttStruct other) {
		...
		public void copyKeysDataTo(ttttStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_origine.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_origine.length == 0) {
						commonByteArray_DEMO_FAY_origine = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_origine = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_origine, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_origine, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_origine) {
		 ...
		 * Compare keys
		 */
		public int compareTo(ttttStruct other) {
	...
	public static class row1Struct implements
		...
		public String origine1;

		public String getOrigine1() {
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ttttStruct tttt = new ttttStruct();
				...
				ttttStruct tttt_tmp = new ttttStruct();
				// ###############################
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 27) {
							...
							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(27);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.origine1 = tmpContent_tMysqlInput_1;
							} else {
								row1.origine1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							// # Output table : 'tttt'
							tttt_tmp.id = row1.id;
							tttt_tmp.year = row1.year;
							tttt_tmp.month = row1.month;
							tttt_tmp.city = row1.city;
							tttt_tmp.group = row1.group;
							tttt_tmp.make = row1.make;
							tttt_tmp.premium_segment = row1.premium_segment;
							tttt_tmp.model_gnr = row1.model_gnr;
							tttt_tmp.model = row1.model;
							tttt_tmp.segment = row1.segment;
							tttt_tmp.ckd_cbu = row1.ckd_cbu;
							tttt_tmp.pc_cv = row1.pc_cv;
							tttt_tmp.engine_type = row1.engine_type;
							tttt_tmp.type = row1.type;
							tttt_tmp.displacement = row1.displacement;
							tttt_tmp.sales = row1.sales;
							tttt_tmp.origine = row1.origine1;
							tttt_tmp.body_type = row1.body_type;
							tttt_tmp.rsp = row1.rsp;
							tttt_tmp.suv_type = row1.suv_type;
							tttt_tmp.price_class = row1.price_class;
							tttt_tmp.log_id = row1.log_id;
							tttt_tmp.type_vh = row1.type_vh;
							tttt_tmp.status = row1.status;
							tttt_tmp.created_at = null;
							tttt_tmp.updated_at = null;
							tttt = tttt_tmp;
							// ###############################
						...
						if (tttt != null) {
							...
							pstmt_tMysqlOutput_1.setInt(1, tttt.year);

							pstmt_tMysqlOutput_1.setInt(2, tttt.month);

							if (tttt.city == null) {
								pstmt_tMysqlOutput_1.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(3, tttt.city);
							}
							...
							if (tttt.group == null) {
								...
								pstmt_tMysqlOutput_1.setString(4, tttt.group);
							}
							...
							if (tttt.make == null) {
								...
								pstmt_tMysqlOutput_1.setString(5, tttt.make);
							}

							if (tttt.premium_segment == null) {
								pstmt_tMysqlOutput_1.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(6,
										tttt.premium_segment);
							}

							if (tttt.model_gnr == null) {
							...
							if (tttt.model == null) {
								...
								pstmt_tMysqlOutput_1.setString(8, tttt.model);
							}

							if (tttt.segment == null) {
								pstmt_tMysqlOutput_1.setNull(9,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(9, tttt.segment);
							}

							if (tttt.ckd_cbu == null) {
								pstmt_tMysqlOutput_1.setNull(10,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1
										.setString(10, tttt.ckd_cbu);
							}
							...
							if (tttt.pc_cv == null) {
								...
								pstmt_tMysqlOutput_1.setString(11, tttt.pc_cv);
							}

							if (tttt.engine_type == null) {
							...
							if (tttt.type == null) {
								...
								pstmt_tMysqlOutput_1.setString(13, tttt.type);
							}

							pstmt_tMysqlOutput_1.setInt(14, tttt.displacement);

							pstmt_tMysqlOutput_1.setInt(15, tttt.sales);

							if (tttt.origine == null) {
								pstmt_tMysqlOutput_1.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1
										.setString(16, tttt.origine);
							}

							if (tttt.body_type == null) {
							...
							pstmt_tMysqlOutput_1.setInt(18, tttt.rsp);

							if (tttt.suv_type == null) {
							...
							pstmt_tMysqlOutput_1.setInt(21, tttt.log_id);

							if (tttt.type_vh == null) {
								pstmt_tMysqlOutput_1.setNull(22,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1
										.setString(22, tttt.type_vh);
							}
							...
							if (tttt.status == null) {
								...
								pstmt_tMysqlOutput_1.setString(23, tttt.status);
							}

							if (tttt.created_at == null) {
								pstmt_tMysqlOutput_1.setNull(24,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_1
										.setInt(24, tttt.created_at);
							}

							if (tttt.updated_at == null) {
								pstmt_tMysqlOutput_1.setNull(25,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_1
										.setInt(25, tttt.updated_at);
							}

							pstmt_tMysqlOutput_1.setLong(
									26 + count_tMysqlOutput_1, tttt.id);
	...
	public static void main(String[] args) {
		final origine origineClass = new origine();

		int exitCode = origineClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = origine.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/origine_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : origine");
		}
...
/************************************************************************************************
 * 74719 characters generated by Talend Open Studio for Data Integration on the
 * November 28, 2015 11:41:10 PM GMT
 ************************************************************************************************/
