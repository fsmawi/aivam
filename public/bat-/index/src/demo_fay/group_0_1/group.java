...
/**
 * Job: group Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class group implements TalendJob {
	...
	private final String jobName = "group";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(group.this, new Object[] { e,
	...
	public static class testStruct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_group = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_group = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_group.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_group.length == 0) {
						commonByteArray_DEMO_FAY_group = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_group = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_group, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_group, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_group) {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 27) {
							...
							tmpContent_tMysqlInput_1 = rs_tMysqlInput_1
									.getString(27);
							if (tmpContent_tMysqlInput_1 != null) {
								row1.group1 = tmpContent_tMysqlInput_1;
							} else {
								row1.group1 = null;
							}
						}
						...
						{ // start of Var scope
							...
							test_tmp.month = row1.month;
							test_tmp.city = row1.city;
							test_tmp.group = row1.group1;
							test_tmp.make = row1.make;
							test_tmp.premium_segment = row1.premium_segment;
							test_tmp.model_gnr = row1.model_gnr;
							test_tmp.model = row1.model;
							test_tmp.segment = row1.segment;
							test_tmp.ckd_cbu = row1.ckd_cbu;
							test_tmp.pc_cv = row1.pc_cv;
							test_tmp.engine_type = row1.engine_type;
							test_tmp.type = row1.type;
							test_tmp.displacement = row1.displacement;
							test_tmp.sales = row1.sales;
							test_tmp.origine = row1.origine;
							test_tmp.body_type = row1.body_type;
							test_tmp.rsp = row1.rsp;
							test_tmp.suv_type = row1.suv_type;
							test_tmp.price_class = row1.price_class;
							test_tmp.log_id = row1.log_id;
							test_tmp.type_vh = row1.type_vh;
							test_tmp.status = row1.status;
							test_tmp.created_at = null;
							test_tmp.updated_at = null;
							test = test_tmp;
							// ###############################
						...
						if (test != null) {
							...
							pstmt_tMysqlOutput_1.setInt(1, test.year);

							pstmt_tMysqlOutput_1.setInt(2, test.month);

							if (test.city == null) {
								pstmt_tMysqlOutput_1.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(3, test.city);
							}
							...
							if (test.group == null) {
								...
								pstmt_tMysqlOutput_1.setString(4, test.group);
							}
							...
							if (test.make == null) {
								...
								pstmt_tMysqlOutput_1.setString(5, test.make);
							}

							if (test.premium_segment == null) {
								pstmt_tMysqlOutput_1.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(6,
										test.premium_segment);
							}

							if (test.model_gnr == null) {
							...
							if (test.model == null) {
								...
								pstmt_tMysqlOutput_1.setString(8, test.model);
							}
							...
							if (test.segment == null) {
								...
								pstmt_tMysqlOutput_1.setString(9, test.segment);
							}

							if (test.ckd_cbu == null) {
								pstmt_tMysqlOutput_1.setNull(10,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1
										.setString(10, test.ckd_cbu);
							}
							...
							if (test.pc_cv == null) {
								...
								pstmt_tMysqlOutput_1.setString(11, test.pc_cv);
							}

							if (test.engine_type == null) {
							...
							if (test.type == null) {
								...
								pstmt_tMysqlOutput_1.setString(13, test.type);
							}

							pstmt_tMysqlOutput_1.setInt(14, test.displacement);

							pstmt_tMysqlOutput_1.setInt(15, test.sales);

							if (test.origine == null) {
								pstmt_tMysqlOutput_1.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1
										.setString(16, test.origine);
							}
							...
							pstmt_tMysqlOutput_1.setInt(18, test.rsp);

							if (test.suv_type == null) {
							...
							pstmt_tMysqlOutput_1.setInt(21, test.log_id);

							if (test.type_vh == null) {
								pstmt_tMysqlOutput_1.setNull(22,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1
										.setString(22, test.type_vh);
							}
							...
							if (test.status == null) {
								...
								pstmt_tMysqlOutput_1.setString(23, test.status);
							}
							...
							if (test.updated_at == null) {
								...
								pstmt_tMysqlOutput_1
										.setInt(25, test.updated_at);
							}

							pstmt_tMysqlOutput_1.setLong(
									26 + count_tMysqlOutput_1, test.id);
	...
	public static void main(String[] args) {
		final group groupClass = new group();

		int exitCode = groupClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = group.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/group_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : group");
		}
...
/************************************************************************************************
 * 74628 characters generated by Talend Open Studio for Data Integration on the
