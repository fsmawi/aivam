...
/**
 * Job: model_1 Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 5.5.1.r118616
 * @status 
 */
public class model_1 implements TalendJob {
	...
	private final String jobName = "model_1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(model_1.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_model_1 = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_model_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_model_1.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_model_1.length == 0) {
						commonByteArray_DEMO_FAY_model_1 = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_model_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_model_1, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAY_model_1, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_1) {
	...
	public static void main(String[] args) {
		final model_1 model_1Class = new model_1();

		int exitCode = model_1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_1.class.getClassLoader()
					.getResourceAsStream(
							"demo_fay/model_1_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : model_1");
		}
...
/************************************************************************************************
 * 136579 characters generated by Talend Open Studio for Data Integration on the
