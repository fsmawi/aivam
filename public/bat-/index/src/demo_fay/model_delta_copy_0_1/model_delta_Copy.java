...
package demo_fay.model_delta_copy_0_1;
...
/**
 * Job: model_delta_Copy Purpose: <br>
 * Description:  <br>
 * @author test@talend.com
 * @version 5.5.1.r118616
 * @status 
 */
public class model_delta_Copy implements TalendJob {
	...
	private final String jobName = "model_delta_Copy";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					model_delta_Copy.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(model_delta_Copy.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_DEMO_FAY_model_delta_Copy = new byte[0];
		static byte[] commonByteArray_DEMO_FAY_model_delta_Copy = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAY_model_delta_Copy.length) {
					if (length < 1024
							&& commonByteArray_DEMO_FAY_model_delta_Copy.length == 0) {
						commonByteArray_DEMO_FAY_model_delta_Copy = new byte[1024];
					} else {
						commonByteArray_DEMO_FAY_model_delta_Copy = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAY_model_delta_Copy, 0,
						length);
				strReturn = new String(
						commonByteArray_DEMO_FAY_model_delta_Copy, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAY_model_delta_Copy) {
				...
				try {
					...
					while (rs_tMysqlInput_2.next()) {
						...
						{ // start of Var scope
							...
							out2_tmp.group = null;
							out2_tmp.make = null;
							out2_tmp.premium_segment = null;
							out2_tmp.model_gnr = null;
							out2_tmp.model = null;
							out2_tmp.segment = null;
							out2_tmp.ckd_cbu = null;
							out2_tmp.pc_cv = null;
							out2_tmp.engine_type = null;
							out2_tmp.type = null;
							out2_tmp.displacement = 0;
							out2_tmp.sales = 0;
							out2_tmp.origine = null;
							out2_tmp.body_type = null;
							out2_tmp.rsp = 0;
							out2_tmp.suv_type = null;
							out2_tmp.price_class = null;
							out2_tmp.log_id = 0;
							out2_tmp.type_vh = null;
							out2_tmp.status = null;
							out2_tmp.created_at = null;
							out2_tmp.updated_at = null;
						...
						if (out2 != null) {
							...
							pstmt_tMysqlOutput_2.setLong(1, out2.id);
	...
	public static void main(String[] args) {
		final model_delta_Copy model_delta_CopyClass = new model_delta_Copy();

		int exitCode = model_delta_CopyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = model_delta_Copy.class
					.getClassLoader().getResourceAsStream(
							"demo_fay/model_delta_copy_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : model_delta_Copy");
		}
...
/************************************************************************************************
 * 127442 characters generated by Talend Open Studio for Data Integration on the
 * October 31, 2014 3:47:29 PM GMT
 ************************************************************************************************/
