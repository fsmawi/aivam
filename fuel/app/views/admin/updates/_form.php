    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Year', 'year', array('class'=>'control-label')); ?>
                ...
                <?php echo Form::input('year', isset($year)?$year:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Year')); ?>
            </div>
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Month', 'month', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('month', isset($month)?$month:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Month')); ?>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-9">
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Group', 'group', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('group',isset($group)?$group:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Group')); ?>
            </div>
            <div class="col-md-2 check-context actions">
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Model gnr', 'model_gnr', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('model_gnr', isset($model_gnr)?$model_gnr:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Model gnr')); ?>
            </div>
            <div class="col-md-2 check-context actions">
        ...
        <div class="form-group">
            <div class="col-md-9">
                ...
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('ckd_cbu', isset($ckd_cbu)?$ckd_cbu:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Ckd cbu')); ?>
            </div>
            <div class="col-md-2 check-context actions">
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Pc cv', 'pc_cv', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('pc_cv', isset($pc_cv)?$pc_cv:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Pc cv')); ?>
            </div>
            <div class="col-md-2 check-context actions">
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Engine type', 'engine_type', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('engine_type', isset($engine_type)?$engine_type:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Engine type')); ?>
            </div>
            <div class="col-md-2 check-context actions">
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Type', 'type', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('type', isset($type)?$type:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Type')); ?>
            </div>
            <div class="col-md-2 check-context actions">
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Displacement', 'displacement', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('displacement', isset($displacement)?$displacement:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Displacement')); ?>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-9">
            <?php echo Form::label('Sales', 'sales', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('sales', isset($sales)?$sales:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Sales')); ?>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-9">
            <?php echo Form::label('Origine', 'origine', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('origine', isset($origine)?$origine:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Origine')); ?>
            </div>
            <div class="col-md-2 check-context actions">
        ...
        <div class="form-group">
            ...
            <?php echo Form::label('Rsp', 'rsp', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('rsp', isset($rsp)?$rsp:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Rsp')); ?>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-9">
            <?php echo Form::label('Price class', 'price_class', array('class'=>'control-label')); ?>
                <span class="glyphicon glyphicon-plus input-control"></span>
                <?php echo Form::input('price_class', isset($price_class)?$price_class:'', array('class' => 'col-md-4 form-control', 'placeholder'=>'Price class')); ?>
            </div>
        </div>
    </fieldset>
  </div>
